...
!function(t,e){"object"==typeof exports&&"undefined"!=typeof module?e(exports):"function"==typeof define&&define.amd?define(["exports"],e):e((t="undefined"!=typeof globalThis?globalThis:t||self).lc={})}(this,function(t){"use strict";function h(){var n={propList:[],add_property:function(t,e,a){n.propList.push(t);var r="get_"+t;return n[t]=function(t){return void 0===t?n[r]():("function"==typeof a&&(t=a(t)),n[r]="function"==typeof t?t:function(){return t},!n.layers&&n.chart||n)},n[r]="function"==typeof e?e:function(){return e},n},wrapSetter:function(t,e){if("function"!=typeof e)throw"Error in 'wrapSetter': wrapper is not a function.";if(-1==n.propList.indexOf(t))throw"Error in 'wrapSetter': this object doesn't have "+t+" property";var a=n[t];return n[t]=function(){return 0==arguments.length?n["get_"+t]():e(a).apply(n,arguments)},n}};return n}function g(t){var e={};return function(){if("clear"!==arguments[0])return arguments in Object.keys(e)||0==arguments.length&&0!=Object.keys(e).length||(e[arguments]=t.apply(void 0,arguments)),e[arguments];e={}}}function m(t,e){if(t.length!=e.length)throw"Error in getEuclideanDistance: length of theinput vectors is not the same";for(var a=0,r=0;r<t.length;r++)a+=(t[r]-e[r])*(t[r]-e[r]);return Math.sqrt(a)}function f(d){function a(n){var o,t=d.svg.select(".selection"),e=d.svg.select(".clickPanel").node().getBoundingClientRect(),l=[d3.max([d3.min([n.clientX-e.left,d.plotWidth()]),0]),d3.max([d3.min([n.clientY-e.top,d.plotHeight()]),0])];h?_||(_=!0,setTimeout(function(){_=!1},100),d.panMove(l)):t.empty()?(o=[],d.container.selectAll("canvas").filter(function(){return d3.select(this).classed("active")}).each(function(){o.push(d3.select(this).attr("id"))}),0<o.length&&f.do(function(){var t=d.findElements(l,l);if(Array.isArray(t))0==t.length?d.get_on_mouseout():d.container.selectAll(".inform").style("left",l[0]+10+d.paddings().left+"px").style("top",l[1]+10+d.paddings().top+"px").select(".value").html(function(){return d.get_informText(t[0][0],t[0][1])});else{for(var e,a=Object.keys(t).length,r=!0;r&&0<a;)a--,e=Object.keys(t)[a],r=0==t[e].length;r||-1==o.indexOf(e)||d.get_layer(e).get_on_mouseover.call(this,t[e][0],n),r&&d.get_on_mouseout&&d.get_layer(e).get_on_mouseout()}})):(t.attr("x",d3.min([l[0],c[0]])).attr("y",d3.min([c[1],l[1]])).attr("width",Math.abs(c[0]-l[0])).attr("height",Math.abs(c[1]-l[1])),(e=(e=d.svg.select(".shadow")).empty()&&10<Math.abs((c[0]-l[0])*(c[1]-l[1]))?d.svg.selectAll(".plotArea").append("path").attr("class","shadow").attr("fill","#444").attr("opacity",.6):e).attr("d","M 0 0 h "+d.plotWidth()+" v "+d.plotHeight()+" h -"+d.plotWidth()+" v -"+d.plotHeight()+" M "+t.attr("x")+" "+t.attr("y")+" v "+t.attr("height")+" h "+t.attr("width")+" v -"+t.attr("height")+" h -"+t.attr("width")))}function r(t){var e,a,r=d.svg.select(".clickPanel").node().getBoundingClientRect(),n=[d3.max([d3.min([t.clientX-r.left,d.plotWidth()]),0]),d3.max([d3.min([t.clientY-r.top,d.plotHeight()]),0])],o=t.shiftKey||d.selectMode(),l=(d.container.selectAll(".inform").classed("blocked",!1),d.svg.select("rect.selection").empty()||(e=[r=+d.svg.selectAll("rect.selection").attr("x"),a=+d.svg.selectAll("rect.selection").attr("y")],a=[r+ +d.svg.selectAll("rect.selection").attr("width"),a+ +d.svg.selectAll("rect.selection").attr("height")]),d.svg.selectAll(".plotArea"));d.svg.selectAll("rect.selection").remove(),d.svg.select(".shadow").remove(),p&&m(i,d3.pointer(t,document.body))<g?(window.clearTimeout(p),p=null,u&&m(s,d3.pointer(t,document.body))<g?(window.clearTimeout(u),u=null,l.on("dbl_click").apply(l,[o])):u=window.setTimeout(function(){l.on("click").call(l,t,n,o),u=null,h&&(h=!1,d.panMove(n),d.container.selectAll(".inform").classed("blocked",!1),d.transitionOff=!1)},300),s=d3.pointer(t,document.body)):h?(h=!1,d.panMove(n),d.container.selectAll(".inform").classed("blocked",!1),d.transitionOff=!1):(e&&(o?d.mark(d.findElements(e,a)):d.zoom(e,a)),document.onmousemove=null,document.onmouseup=null)}var i,s,c,u=null,p=null,g=5,f=e(100),h=!1,t=(d.svg.selectAll(".plotArea").append("rect").attr("class","clickPanel").attr("fill","transparent").lower(),d.updateSize),_=!(d.updateSize=function(){return t(),d.svg.selectAll(".clickPanel").attr("width",d.plotWidth()).attr("height",d.plotHeight()),d});return d.svg.selectAll(".plotArea").on("mousedown",function(t){d.container.selectAll(".hint").remove();var e=d3.pointer(t,this);-1<navigator.userAgent.toLowerCase().indexOf("firefox")&&(e[0]-=d.paddings().left,e[1]-=d.paddings().top),i=d3.pointer(t,document.body),c=e.slice(),p=window.setTimeout(function(){p=null},1e3),d.pan("mode")||d.svg.selectAll(".plotArea").append("rect").attr("class","selection").attr("x",e[0]).attr("y",e[1]).attr("width",1).attr("height",1),d.pan("mode")&&(h=!0,d.pan("down",c),d.transitionOff=!0),d.container.selectAll(".inform").classed("blocked",!0),document.addEventListener("mousemove",a,!1),document.addEventListener("mouseup",r,!1)},!0).on("dbl_click",function(t){t?d.mark("__clear__"):d.resetDomain()},!0).on("click",function(e,t,a){if(e.stopPropagation(),void 0!==t){d.clickPosition&&!a&&d.clickPosition(t);var r=d.findElements(t,t);if(0!=r.length)if(a)d.mark(r);else{var n=[];if(d.container.selectAll("canvas").filter(function(){return d3.select(this).classed("active")}).each(function(){n.push(d3.select(this).attr("id"))}),0<n.length){if(Array.isArray(r))d.get_on_click(r[0][0],r[0][1]);else for(var o,l=Object.keys(r).length,i=!0;i&&0<l;)if(l--,0!=r[o=Object.keys(r)[l]].length)if(d.clickSingle())i=!1,d.get_layer(o).get_on_click.call(this,r[o][0]);else for(var s=0;s<r[o].length;s++)d.get_layer(o).get_on_click.call(this,r[o][s])}else{t=d.get_elements(r),a=t.filter(function(t){return t==d.container.selectAll(".inform").datum()});a.empty()||(t=a),(t=d.clickSingle()?d3.select(t.node()):t).each(function(t){d3.select(this).on("click").call(this,e,t)})}}}},!0),d.container.node().addEventListener("mousemove",a,!1),d}function y(t,e){return 3.14*Math.pow(28.2*e/{Circle:30,Cross:35,Diamond:46,Square:36,Star:47,Triangle:44,Wye:37}[t],2)}function _(t){return t.replace(/[\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&")}function e(r){var n={interval:r,prev_time:-1/0,timer:null,do:function(){for(var t=arguments[0],e=[],a=1;a<arguments.length;a++)e.push(arguments[a]);n.timer&&n.timer.stop(),d3.now()-n.prev_time>=r?(t.call(this,e),n.prev_time=d3.now()):n.timer=d3.timeout(t,1.5*r)}};return n}function v(t,r){return"number_nonneg"==t?function(t){if("function"==typeof t)return t;if("number"!=typeof(t=a(+t)?t:+t))throw"Error in 'typeCheck' for property '"+r+"': numeric value is required.";if(0<=t)return t;throw"Error in 'typeCheck' for property '"+r+"': negative values are not allowed."}:"array"==t?function(t){if("function"==typeof t)return t;if(Array.isArray(t))return t;if("object"==typeof t){var e=[];for(el in t){if("string"!=typeof t[el]&&"number"!=typeof t[el])throw"Error in 'typeCheck' for property '"+r+"': the value is not an array.";e.push(t[el])}return e}if("number"==typeof t||"string"==typeof t)return[t];throw"Error in 'typeCheck' for property '"+r+"': the value is not an array."}:"array_fun"==t?function(e){return e&&"object"==typeof e?function(t){return e[t]}:e}:(t="matrix_fun",function(a){if("function"==typeof a)return a;var t;if(a&&"object"==typeof a)return t=Object.keys(a),"object"==typeof a[t[0]]?function(t,e){return a[t][e]}:function(t){return a[t]};throw"Error in 'typeCheck' for property '"+r+"': the value is not an array or an object."})}function a(t){return null==t||"NA"==t||"NaN"==t||"NAN"==t||"na"==t||"Infinity"==t||"Inf"==t}function s(t){function l(){return"default"==c.mode()?2500<c.nelements()?"canvas":"svg":c.mode()}var c=h().add_property("nelements",void 0,v("number_nonneg","nelements")).add_property("elementIds",void 0,v("array","elementIds")).add_property("label",function(t){return t},v("array_fun","label")).add_property("on_mouseover",function(){}).add_property("on_mouseout",function(){}).add_property("mode","svg").add_property("on_click",function(){}).add_property("layerDomainX",void 0,v("array","layerDomainX")).add_property("layerDomainY",void 0,v("array","layerDomainY")).add_property("contScaleX",function(){var t=c.layerDomainX();return void 0===t||2==t.length&&"number"==typeof t[0]&&"number"==typeof t[1]}).add_property("contScaleY",function(){var t=c.layerDomainY();return void 0===t||2==t.length&&"number"==typeof t[0]&&"number"==typeof t[1]}).add_property("colour",function(t){return c.colourScale(c.get_colourValue(t))},v("array_fun","colour")).add_property("addColourScaleToLegend",!0).add_property("palette",void 0,v("array","palette")).add_property("colourDomain",v("array","colourDomain")).add_property("colourValue",void 0,v("array_fun","colourValue")).add_property("colourLegendTitle","").add_property("opacity",1,v("array_fun","opacity")).add_property("dresser",function(){}).add_property("on_marked",function(){c.chart.on_marked()}).add_property("informText",function(t){return"<b>ID:</b> "+c.get_label(t)},v("array_fun","opacity"));c.propList=c.propList.concat(["updateElementStyle","updateElements","updateElementPosition"]),c.id=t,c.marked=[],c.wrapSetter("nelements",function(t){return function(){return c.get_elementIds=function(){return d3.range(t())},t.apply(c,arguments)}}),c.wrapSetter("elementIds",function(t){return function(){return c.get_nelements=function(){return t().length},t.apply(c,arguments)}}),c.wrapSetter("colour",function(t){return function(){return c.addColourScaleToLegend(!1),t.apply(c,arguments)}}),c.colourDomain(function(){var t=c.elementIds().map(t=>c.get_colourValue(t));if(0!=t.length){if(1==t.length)return void 0===t[0]?[]:t;var e=-1;if("number"==typeof t[1]&&"number"==typeof t[2])for(a=t[1]>t[0]?[t[0],t[1]]:[t[1],t[0]],e=2;e<t.length&&("number"==typeof t[e]||lc.isNaN(t[e]));)a[0]>t[e]&&(a[0]=t[e]),a[1]<t[e]&&(a[1]=t[e]),e++;if(e<t.length)for(var a=[],e=0;e<t.length;e++)-1==a.indexOf(t[e])&&void 0!==t[e]&&a.push(t[e]);return a}}),c.colourScale=function(){return"black"},c.resetColourScale=function(){var t=c.colourDomain();if(void 0!==t&&0!=t.length){if(c.chart.globalColourScale()){var e,t=c.chart.globalColourDomain(c.id,t);for(e in c.chart.layers){var a,r=c.chart.get_layer(e);e==c.id||r.globalScaleUpdate||(r.globalScaleUpdate=!0,a=r.updateStarted,r.updateStarted=!0,r.updateElementStyle(),r.updateStarted=a,r.globalScaleUpdate=!1)}}var n=!0;t=t.filter(t=>!lc.isNaN(t));for(var o=0;o<t.length;o++)n=n&&"number"==typeof t[o];n&&t.sort(function(t,e){return t-e});var l=c.palette();if(n)if(t=t.filter(function(t){return"Infinity"!=t}),null==l&&(l=d3.interpolateSpectral||["red","yellow","green","blue"]),Array.isArray(l)){if((l=l.map(t=>/^#[0-9a-fA-F]{8,8}$/.test(t)?t.substring(0,7):t)).length!=t.length&&(t=[d3.min(t),d3.max(t)]),1==l.length&&l.push(l[0]),l.length>t.length){for(var i=[],o=0;o<l.length;o++)i.push(t[0]+o*(t[1]-t[0])/(l.length-1));t=i}c.colourValueScale=d3.scaleLinear().domain(t).range(l),c.colourScale=function(t){return c.colourValueScale(t)}}else{t=[d3.min(t),d3.max(t)];var s=[0,1];l.domain&&(s=l.domain()),c.colourValueScale=d3.scaleLinear().domain(t).range(s),c.colourScale=function(t){return null==t?"#999":l(c.colourValueScale(t))}}else if((l=void 0===l?d3.schemeCategory10:l).length){for(var d=l.length,o=0;o<t.length-d;o++)l.push(l[o%d]);c.colourValueScale=d3.scaleOrdinal().domain(t).range(l).unknown("black"),c.colourScale=function(t){return c.colourValueScale(t)}}else{s=[0,1];l.domain&&(s=l.domain()),c.colourValueScale=d3.scalePoint().domain(t).range(s),c.colourScale=function(t){return null==t?"#999":l(c.colourValueScale(t))}}c.colourScale.domain=c.colourValueScale.domain,c.chart.showLegend()&&c.addColourScaleToLegend()&&((s={})[c.id+"_colour"]=c.colourLegendTitle(),c.chart.legend.set_title(s),c.addLegendBlock(c.colourScale,"colour",c.id+"_colour"))}},c.legendBlocks=[],c.addLegendBlock=function(t,e,a){return c.chart.legend.add_block(t,e,a,c),-1==c.legendBlocks.indexOf(a)&&c.legendBlocks.push(a),c},c.update=function(){return c.updateStarted=!0,c.updateElements(),c.updateElementStyle(),c.updateElementPosition(),c.updateStarted=!1,c};return c.put_static_content=function(){c.g=c.chart.svg.selectAll(".plotArea").append("g").attr("class","chart_g").attr("id",c.id),c.canvas=c.chart.container.append("canvas").style("position","absolute").style("z-index",-5).attr("id",c.id),("svg"==l()?c.g:c.canvas).classed("active",!0)},c.updateElements=function(){},c.updateElementStyle=function(){return c.resetColourScale(),c.get_dresser(c.g.selectAll(".data_element")),0!=c.get_marked().length&&c.colourMarked(),c},c.updateElementPosition=function(){},c.findElements=function(){return[]},c.get_position=function(t){},c.on_mouseover(function(t,e){var a=c.chart.container.node().getBoundingClientRect(),a=[d3.max([d3.min([e.clientX-a.left,c.chart.plotWidth()]),0]),d3.max([d3.min([e.clientY-a.top,c.chart.plotHeight()]),0])];this&&!this.prev_time&&d3.select(e.target).attr("fill",function(t){return d3.rgb(c.get_colour(t)).darker(.5)}).classed("hover",!0),c.chart.container.selectAll(".inform").data([t]).style("left",a[0]+10+"px").style("top",a[1]+10+"px").select(".value").html(c.get_informText(t)),c.chart.container.selectAll(".inform").classed("hidden",!1)}),c.on_mouseout(function(t,e){var a;e&&(a=0<c.get_marked().length,d3.select(e.target).attr("fill",function(t){return a^d3.select(this).classed("marked")?"#aaa":c.get_colour(t)}).classed("hover",!1)),c.chart.container.selectAll(".inform").classed("hidden",!0)}),c.get_marked=function(){return"svg"==l()?c.g.selectAll(".data_element").filter(function(){return d3.select(this).classed("marked")}).data():c.marked},c.checkMode=function(){if("svg"==l()&&c.canvas.classed("active"))return c.canvas.classed("active",!1),c.g.classed("active",!0),c.canvas.node().getContext("2d").clearRect(0,0,c.chart.plotWidth(),c.chart.plotHeight()),!!c.updateStarted||(c.update(),!1);if("canvas"==l()&&c.g.classed("active"))for(c.canvas.classed("active",!0),c.g.classed("active",!1);c.g.node().firstChild;)c.g.node().removeChild(c.g.node().firstChild);return!0},c.mark=function(t,e){if("svg"==l()){if("__clear__"==t)return c.g.selectAll(".data_element.marked").classed("marked",!1),c.g.selectAll(".data_element").attr("opacity",1),e||c.on_marked(),c.colourMarked(),c.chart;var a;if(t.empty||((a={})[c.id]=t,t=c.chart.get_elements(a)),t.empty())return c.chart;1==t.size()?t.classed("marked",!t.classed("marked")):t.classed("marked",!0),c.colourMarked()}else{if("__clear__"==t)c.marked=[];else for(var r,n=c.marked.map(function(t){return Array.isArray(t)?t.join("_"):t}),o=0;o<t.length;o++)-1==(r=t[o].join?n.indexOf(t[o].join("_")):n.indexOf(t[o]))?c.marked.push(t[o]):1==t.length&&c.marked.splice(r,1);c.updateCanvas()}e||c.on_marked()},c.colourMarked=function(){var t;"svg"==l()&&((t={})[c.id]=c.get_marked(),(t=c.chart.get_elements(t)).empty()?c.g.selectAll(".data_element").attr("fill",function(t){return c.get_colour(t)}):c.g.selectAll(".data_element").attr("fill",function(t){return d3.select(this).classed("marked")?c.get_colour(t):"#aaa"}))},c}function l(l){var a,i=h().add_property("x",function(){return l.width()-i.buttonSize()-5}).add_property("y",function(){return.05*l.paddings().top}).add_property("orientation","horizontal").add_property("height",function(){if("vertical"==i.orientation())return Math.floor(i.y()/i.buttonSize())*i.buttonSize()}).add_property("width",function(){if("horizontal"==i.orientation())return Math.floor(i.x()/i.buttonSize())*i.buttonSize()}).add_property("buttonSize",30),o=(i.chart=l,{}),s=[];function t(t,e,a){var r,n;if(a){for(n=d3.min([e,a]),r=1;Math.floor(e/n)*r<t;)r++,n=d3.min([a/r,n]);i.buttonSize(n)}else n=i.buttonSize(),r=Math.ceil(e/n);o={width:i.width(),height:i.height(),rowLength:d3.min([Math.floor(e/n),s.length])},"horizontal"==i.orientation()?o.width=n*o.rowLength:o.height=n*o.rowLength}return i.wrapSetter("orientation",function(t){return function(){if(-1==["vertical","horizontal"].indexOf(t()))throw"Error in 'panel.orientation': value "+t()+" is not allowed for this property. Possible values are 'horizontal' or 'vertical'.";return t.apply(i,arguments)}}),i.put_static_content=function(){var t,e;i.g=i.chart.svg.append("g").attr("class","panel_g"),t=i.g.append("def"),a=i.buttonSize()-10,(e=t.append("g").attr("id","toggleOff")).append("rect").attr("stroke-width",2).attr("width",a).attr("height",a).attr("fill","#aaa").attr("stroke","#444"),e.append("path").attr("d","M "+a/2+" "+Math.floor(a/3)+" L "+Math.ceil(2*a/3)+" "+Math.ceil(2*a/3)+" H "+Math.floor(a/3)+" L "+a/2+" "+Math.floor(a/3)).attr("fill","#444").attr("stroke-width",0),(e=t.append("g").attr("id","toggleOnHor")).append("rect").attr("stroke-width",2).attr("width",a).attr("height",a).attr("fill","#aaa").attr("stroke","#444"),e.append("path").attr("d","M "+Math.floor(a/3)+" "+a/2+" L "+Math.ceil(2*a/3)+" "+Math.floor(a/3)+" V "+Math.floor(2*a/3)+" L "+Math.floor(a/3)+" "+a/2).attr("fill","#444").attr("stroke-width",0),(e=t.append("g").attr("id","toggleOnVer")).append("rect").attr("stroke-width",2).attr("width",a).attr("height",a).attr("fill","#aaa").attr("stroke","#444"),e.append("path").attr("d","M "+a/2+" "+Math.ceil(2*a/3)+" L "+Math.floor(a/3)+" "+Math.floor(a/3)+" H "+Math.floor(2*a/3)+" L "+a/2+" "+Math.ceil(2*a/3)).attr("fill","#444").attr("stroke-width",0),(e=t.append("g").attr("id","save")).append("rect").attr("stroke-width",0).attr("width",a).attr("height",a).attr("fill","#444").attr("rx",a/10).attr("ry",a/10),e.append("path").attr("d","M "+Math.floor(4*a/5)+" 0 H "+a+" V "+Math.ceil(a/5)+" L "+Math.floor(4*a/5)+" 0").attr("fill","#fff").attr("stroke-width",0),e.append("rect").attr("x",Math.floor(a/3)).attr("height",Math.floor(a/3)).attr("width",Math.ceil(2*a/5)).attr("fill","#fff").attr("stroke-width",0),e.append("rect").attr("x",Math.floor(44*a/75)).attr("width",Math.ceil(2*a/25)).attr("height",Math.ceil(a/4)).attr("fill","#444").attr("stroke-width",0),e.append("rect").attr("x",Math.floor(a/4)).attr("width",Math.ceil(5*a/12)).attr("y",a/2).attr("height",a/2).attr("rx",a/10).attr("ry",a/10).attr("fill","#fff").attr("stroke-width",0),(e=t.append("g").attr("id","svg")).append("text").attr("font-size",1.5*a).attr("textLength",a).attr("lengthAdjust","spacingAndGlyphs").attr("fill","#444").attr("y",a).attr("font-weight",900).attr("font-family","Verdana").text("SVG"),(e=t.append("g").attr("id","selection")).append("rect").attr("fill-opacity",0).attr("width",Math.floor(2*a/3)).attr("height",Math.floor(2*a/3)).attr("x",Math.ceil(a/3)).attr("stroke","#444").attr("stroke-width",1).attr("stroke-dasharray",2),e.append("path").attr("fill","#444").attr("stroke-width",0).attr("stroke","#444").attr("d","M "+Math.ceil(a/3)+" "+Math.floor(2*a/3)+" L 0 "+Math.ceil(3*a/4)+" l "+a/12+" "+a/12+" L 0 "+9*a/10+" L "+a/10+" "+a+" L "+11*a/60+" "+11*a/12+" L "+Math.floor(a/4)+" "+a+" L "+Math.ceil(a/3)+" "+Math.floor(2*a/3)),e.append("circle").attr("cx",Math.floor(a/5)).attr("cy",Math.floor(a/5)).attr("r",2).attr("fill","#444"),e.append("circle").attr("cx",Math.floor(4*a/5)).attr("cy",Math.floor(4*a/5)).attr("r",2).attr("fill","#444"),e.append("circle").attr("cx",Math.floor(2*a/3)).attr("cy",Math.floor(a/3)).attr("r",3).attr("fill","#111"),(e=t.append("g").attr("id","zoomIn")).append("path").attr("fill","#444").attr("d","M "+2*a/5+" 0 h "+a/5+" v "+2*a/5+" h "+2*a/5+" v "+a/5+" h -"+2*a/5+" v "+2*a/5+" h -"+a/5+" v -"+2*a/5+" h -"+2*a/5+" v -"+a/5+" h "+2*a/5+" v -"+2*a/5),(e=t.append("g").attr("id","zoomOut")).append("rect").attr("y",3*a/8).attr("height",a/4).attr("width",a).attr("fill","#444"),(e=t.append("g").attr("id","home")).append("rect").attr("x",a/5).attr("y",2*a/5).attr("width",3*a/5).attr("height",3*a/5).attr("fill","#444"),e.append("rect").attr("x",2*a/5).attr("y",3*a/5).attr("width",a/5).attr("height",a/5).attr("fill","#fff"),e.append("path").attr("fill","#444").attr("d","M 0 "+2*a/5+" L "+a/2+" 0 L "+a+" "+2*a/5),e.append("path").attr("stroke","#fff").attr("stroke-width",1).attr("d","M 0 "+2*a/5+" L "+a+" "+2*a/5),(e=t.append("g").attr("id","pan")).append("path").attr("fill","#444").attr("d","M 0 "+a/2+" l "+a/5+" -"+a/5+" v "+a/10+" h "+a/5+" v -"+a/5+" h -"+a/10+" L "+a/2+" 0 l "+a/5+" "+a/5+" h -"+a/10+" v "+a/5+" h "+a/5+" v -"+a/10+" L "+a+" "+a/2+" l -"+a/5+" "+a/5+" v -"+a/10+" h -"+a/5+" v "+a/5+" h "+a/10+" L "+a/2+" "+a+" l -"+a/5+" -"+a/5+" h "+a/10+" v -"+a/5+" h -"+a/5+" v "+a/10+" L 0 "+a/2),(e=t.append("g").attr("id","fitSelected")).append("rect").attr("x",a/5).attr("y",a/5).attr("width",3*a/5).attr("height",3*a/5).attr("fill","#fff").attr("stroke","#444").attr("stroke-width",1).attr("stroke-dasharray",2),e.append("circle").attr("cx",a/5-3).attr("cy",a/2).attr("r",2).attr("fill","#444"),e.append("circle").attr("cx",3*a/5).attr("cy",a/5-3).attr("r",2).attr("fill","#444"),e.append("circle").attr("cx",4*a/5+3).attr("cy",2*a/5).attr("r",2).attr("fill","#444"),e.append("circle").attr("cx",2*a/5).attr("cy",4*a/5+3).attr("r",2).attr("fill","#444"),e.append("circle").attr("cx",4*a/5-3).attr("cy",a/5+3).attr("r",3).attr("fill","#111"),e.append("circle").attr("cx",a/5+3).attr("cy",4*a/5-3).attr("r",3).attr("fill","#111"),(e=t.append("g").attr("id","clusterRows")).append("rect").attr("x",2*a/5).attr("width",3*a/5).attr("height",a).attr("fill","#444"),e.append("rect").attr("stroke","#444").attr("stroke-width",1).attr("fill","#fff").attr("y",a/5).attr("height",a/2).attr("width",2*a/5),e.append("rect").attr("stroke","#444").attr("stroke-width",1).attr("fill","#fff").attr("y",a/10).attr("x",a/5).attr("height",a/5).attr("width",a/5),e.append("rect").attr("stroke","#444").attr("stroke-width",1).attr("fill","#fff").attr("x",a/10).attr("y",a/2).attr("height",3*a/10).attr("width",3*a/10),e.append("rect").attr("stroke","#444").attr("stroke-width",1).attr("fill","#fff").attr("x",a/5).attr("y",7*a/10).attr("height",a/5).attr("width",a/5),e.append("path").attr("stroke","#fff").attr("stroke-width",1).attr("d","M "+2*a/5+" "+a/5+" L "+a+" "+a/5),e.append("path").attr("stroke","#fff").attr("stroke-width",1).attr("d","M "+2*a/5+" "+2*a/5+" L "+a+" "+2*a/5),e.append("path").attr("stroke","#fff").attr("stroke-width",1).attr("d","M "+2*a/5+" "+3*a/5+" L "+a+" "+3*a/5),e.append("path").attr("stroke","#fff").attr("stroke-width",1).attr("d","M "+2*a/5+" "+4*a/5+" L "+a+" "+4*a/5),(e=t.append("g").attr("id","clusterCols")).append("rect").attr("y",2*a/5).attr("height",3*a/5).attr("width",a).attr("fill","#444"),e.append("rect").attr("stroke","#444").attr("stroke-width",1).attr("fill","#fff").attr("x",a/5).attr("width",a/2).attr("height",2*a/5),e.append("rect").attr("stroke","#444").attr("stroke-width",1).attr("fill","#fff").attr("x",a/10).attr("y",a/5).attr("width",a/5).attr("height",a/5),e.append("rect").attr("stroke","#444").attr("stroke-width",1).attr("fill","#fff").attr("y",a/10).attr("x",a/2).attr("width",3*a/10).attr("height",3*a/10),e.append("rect").attr("stroke","#444").attr("stroke-width",1).attr("fill","#fff").attr("y",a/5).attr("x",7*a/10).attr("width",a/5).attr("height",a/5),e.append("path").attr("stroke","#fff").attr("stroke-width",1).attr("d","M "+a/5+" "+2*a/5+" L "+a/5+" "+a),e.append("path").attr("stroke","#fff").attr("stroke-width",1).attr("d","M "+2*a/5+" "+2*a/5+" L "+2*a/5+" "+a),e.append("path").attr("stroke","#fff").attr("stroke-width",1).attr("d","M "+3*a/5+" "+2*a/5+" L "+3*a/5+" "+a),e.append("path").attr("stroke","#fff").attr("stroke-width",1).attr("d","M "+4*a/5+" "+2*a/5+" L "+4*a/5+" "+a),(e=t.append("g").attr("id","restoreOrder")).append("text").attr("font-size",1.5*a).attr("textLength",a).attr("lengthAdjust","spacingAndGlyphs").attr("fill","#444").attr("y",a).attr("font-weight",900).attr("font-family","Verdana").text("123"),t.selectAll("rect").attr("transform","translate(5, 5)"),t.selectAll("path").attr("transform","translate(5, 5)"),t.selectAll("text").attr("transform","translate(5, 5)"),t.selectAll("circle").attr("transform","translate(5, 5)"),t.selectAll("g").append("rect").attr("fill","transparent").attr("width",i.buttonSize()).attr("height",i.buttonSize()).lower(),i.g.append("use").attr("xlink:href","#toggleOff").attr("id","toggle").attr("opacity",.7).attr("title","Click to show instrument panel").on("mouseover",function(){d3.select(this).attr("opacity",1)}).on("mouseout",function(){d3.select(this).attr("opacity",.7)}).on("click",i.show).append("title").text("Click to show instrument panel"),i.g.append("g").attr("id","buttonPanel").attr("class","hidden")},i.updateSize=function(){"horizontal"==i.orientation()?(t(s.length,i.width(),i.height()),i.g.selectAll(".button").attr("transform",function(t,e){return"translate("+e%o.rowLength*i.buttonSize()+", "+Math.floor(e/o.rowLength)*i.buttonSize()+") scale("+(i.buttonSize()-10)/a+")"})):(t(s.length,i.height(),i.width()),i.g.selectAll(".button").attr("transform",function(t,e){return"translate("+Math.floor(e/o.rowLength)*i.buttonSize()+", "+(e%o.rowLength+1)*i.buttonSize()+") scale("+(i.buttonSize()-10)/a+")"})),"vertical"==i.orientation()?(i.g.attr("transform","translate("+i.x()+", "+i.y()+")"),i.g.select("#toggle").attr("transform","translate(0, 0)"),i.g.select("#buttonPanel").attr("transform","translate(0, "+i.buttonSize()+")")):(i.g.attr("transform","translate("+(i.x()-o.width)+", "+i.y()+")"),i.g.select("#toggle").attr("transform","translate("+o.width+", 0)"),i.g.select("#buttonPanel").attr("transform","translate(0, 0)"))},i.add_button=function(t,e,r,n){var o=!1;return s.push({name:t,icon:e,fun:function(t,e){var a;o||((a=n)&&l.container.append("div").attr("class","hint").style("left",i.chart.width()-105+"px").style("top",i.y()+i.g.node().getBBox().height+"px").text(a),o=!0),r(t,e)}}),i.g.select("#buttonPanel").selectAll(".button").data(s,function(t){return t.name}).enter().append("use").attr("opacity",.6).attr("class","button").attr("id",function(t){return"b_"+t.icon.substr(1)}).attr("xlink:href",function(t){return t.icon}).on("click",function(t,e){e.fun(i.chart,d3.select(this))}).on("mouseover",function(){d3.select(this).attr("opacity",1)}).on("mouseout",function(){d3.select(this).attr("opacity",.6)}).append("title").text(function(t){return t.name}),i},i.show=function(){i.g.select("#toggle").attr("opacity",1).on("click",i.hide).on("mouseout",function(){}).select("title").text("Click to hide instrument panel"),"horizontal"==i.orientation()?i.g.select("#toggle").attr("xlink:href","#toggleOnHor"):i.g.select("#toggle").attr("xlink:href","#toggleOnVer"),i.g.select("#buttonPanel").classed("hidden",!1)},i.hide=function(){i.g.select("#toggle").attr("xlink:href","#toggleOff").attr("opacity",.7).on("click",i.show).on("mouseout",function(){d3.select(this).attr("opacity",.7)}).select("title").text("Click to show instrument panel"),i.g.select("#buttonPanel").classed("hidden",!0)},i}function i(t){var h=lc.base().add_property("width",100).add_property("height",function(){return t.height()}).add_property("sampleHeight",20).add_property("titles",{}).add_property("ncol").add_property("container",void 0,function(t){if(void 0===(t="string"==typeof t?d3.select(t):t).select)throw"Error in 'typeCheck' for property 'container': a D3 selection or a valid selector is required.";return t=t.empty()?d3.select("body"):t}),_={},o=(h.chart=t,h.set_title=function(t){var e,a=h.titles();for(e in t)a[e]=t[e];return h.titles(a),h},h.get_nblocks=function(){return Object.keys(_).length},h.get_blockIds=function(){return Object.keys(_)},h.add_block=function(t,e,a,r){if(!(h.chart.globalColourScale&&"colour"===e&&h.chart.globalColourScale()&&void 0===_[a]&&-1<Object.keys(_).map(t=>_[t].type).indexOf("colour"))){var n={};if(n.scale="function"==typeof t?t:function(){return t},void 0!==r&&(n.layer=r),-1==["colour","size","symbol","dash"].indexOf(e))throw"Error in 'legend.add_block': "+e+" is not a suitable type of legend block. Please, use one of these: 'colour', 'size', 'symbol', 'dash'";n.type=e,_[a]=n,h.container()&&o()}return h.chart},h.updateScale=function(t,e){if(void 0===_[e])throw"Error in 'legend.updateScale': A block with ID "+e+" is not defined";return _[e].scale=t,h.updateBlock(e),h.chart},h.removeBlock=function(t){if(void 0===_[t])throw"Error in 'legend.remove': block with ID "+t+" doesn't exist";return void 0!==_[t].layer&&_[t].layer.legendBlocks.splice(_[t].layer.legendBlocks.indexOf(t),1),delete _[t],h.legendTable.select("#"+t).remove(),o(),h.chart},h.renameBlock=function(t,e){return _[e]=_[t],delete _[t],void 0!==_[e].layer&&_[e].layer.legendBlocks.splice(_[e].layer.legendBlocks.indexOf(t),1,e),h.legendTable&&(h.legendTable.select("#"+t).attr("id",e),h.updateBlock(e)),h.chart},function(){var a,t=Object.keys(_).length;if(void 0===h.ncol()){for(var e,r=1+t,n=1,o=2;o<=Math.ceil(Math.sqrt(t));o++)o+(e=Math.ceil(t/o))<=r&&(r=o+e,n=o);a=Math.ceil(t/n)}else a=h.ncol(),n=Math.ceil(t/a);for(o in h.legendTable&&h.legendTable.remove(),h.legendTable=h.container().append("table").attr("class","legendTable linked-charts"),h.legendTable.selectAll("tr").data(d3.range(n)).enter().append("tr"),h.legendTable.selectAll("tr").selectAll("td").data(function(e){return d3.range(a).map(function(t){return[e,t]})}).enter().append("td").attr("id",function(t){try{return Object.keys(_)[t[0]*a+t[1]].replace(/[ .]/g,"_")}catch(t){}}),_)h.updateBlock(o)});return h.updateBlock=function(a){if(void 0===_[a])throw"Error in 'legend.updateBlock': block with ID "+a+" is not defined";for(var t,e,r=function(t){var e,a;if("function"!=typeof(e=void 0===(e="function"==typeof _[t].scale?_[t].scale():e)||"function"!=typeof e&&void 0===e.splice?_[t].scale:e)){var r=!1,n=!1;if(1==e.length)throw"Error in 'legend.convertScale': range of the scale is not defined.";2==e[0].length&&"number"==typeof e[0][0]&&"number"==typeof e[0][1]&&(r=!0),"colour"==_[t].type&&e[0].length!=e[1].length&&(n=!0),2==e[1].length&&"number"==typeof e[0][0]&&"number"==typeof e[0][1]&&(n=!0),r&&n&&(a=d3.scaleLinear().domain(e[0]).range(e[1]),e.steps?a.steps=e.steps:a.steps=9),r&&!n&&((a=d3.scaleQuantize().domain(e[0]).range(e[1])).steps=e[1].length),!r&&n&&((a=d3.scalePoint().domain(e[0]).range(e[1])).steps=e[0].length),r||n||(e[0].length>e[1].length&&e[0].splice(e[1].length),e[1].length>e[0].length&&e[1].splice(e[0].length),(a=d3.scaleOrdinal().domain(e[0]).range(e[1])).steps=e[0].length),_[t].domain=e[0],void 0===a.domain&&(a.domain=_[t].domain)}else{var o="function"==typeof e.domain?e.domain():e.domain;if(void 0===o)throw"Error in 'legend.convertScale': the domain of the scale is not defined.";for(var l=0;l<o.length;)void 0===o[l]?o.splice(l,1):l++;if(_[t].domain=o,(a=e).steps)a.steps=e.steps;else{for(var i=!0,l=0;i&&l<o.length;)i=i&&"number"==typeof o[l],l++;2==(o=i?d3.extent(o):o).length&&"number"==typeof o[0]?a.steps=9:a.steps=o.length}}return a}(a),n=h.legendTable.select("#"+a.replace(/[ .]/g,"_")),o=h.width()/h.legendTable.select("tr").selectAll("td").size(),l=r.steps,i=h.sampleHeight()*l,s=n.selectAll("svg"),n=((s=s.empty()?n.append("svg"):s).attr("width",o).attr("height",i),s.select(".title")),d=(n.empty()&&(n=s.append("g").attr("class","title")).append("text").attr("class","plainText").attr("text-anchor","left"),d3.min([20,.2*o])),c=n.select("text").attr("font-size",d-3).attr("y",d-5).text(""==h.titles()[a]?"":h.titles()[a]||a).node().getBoundingClientRect().width,u=(i<c&&n.select("text").attr("font-size",d3.max([10,(d-3)*i/c])),n.attr("transform","rotate(-90)translate(-"+i+", 0)"),t=_[a].domain.length==l?_[a].domain:d3.range(l).map(function(t){var e=_[a].domain.length-1;return _[a].domain[e]-t*(_[a].domain[e]-_[a].domain[0])/(l-1)}),[]),p=0;p<t.length;p++)"number"==typeof t[p]&&(100<=Math.abs(t[p])?t[p]=t[p].toFixed(0):10<=Math.abs(t[p])?t[p]=t[p].toFixed(1):Math.abs(1<=t[p]||0==t[p])?t[p]=t[p].toFixed(2):(e=1-Math.floor(Math.log(Math.abs(t[p]))/Math.log(10)),t[p]=3<e?t[p].toExponential(2):t[p].toFixed(e))),u.push([t[p]]);var g,c=s.selectAll(".sample").data(u);c.exit().remove(),c.enter().append("g").attr("class","sample").merge(c).attr("transform",function(t,e){return"translate("+(d+1)+", "+e*h.sampleHeight()+")"}),"colour"==_[a].type&&(n=s.selectAll(".sample").selectAll("rect").data(function(t){return t})).enter().append("rect").merge(n).attr("width",d).attr("height",h.sampleHeight()).attr("fill",function(t){return r(t)}),"symbol"==_[a].type&&(g=d3.min([h.sampleHeight()/2,d/2]),(i=s.selectAll(".sample").selectAll("path").data(function(t){return t})).enter().append("path").merge(i).attr("d",function(t){return d3.symbol().type(d3["symbol"+r(t)]).size(y(r(t),g))()}).attr("transform","translate("+g+", "+g+")")),"dash"==_[a].type&&(c=s.selectAll(".sample").selectAll("line").data(function(t){return t})).enter().append("line").style("stroke","black").merge(c).attr("x1",0).attr("x2",d).attr("y1",h.sampleHeight()/2).attr("y2",h.sampleHeight()/2).attr("stroke-dasharray",function(t){return r(t)});s.selectAll(".sample").selectAll("g").data(function(t){return"number"==typeof t[0]?[t[0].toString()]:t}).enter().append("g").append("text").attr("class","plainText").attr("text-anchor","left").attr("dominant-baseline","middle"),s.selectAll(".sample").selectAll("g").attr("transform","translate("+(d+5)+", 0)");var n=s.selectAll(".sample").selectAll("g").selectAll("text").attr("font-size",h.sampleHeight()-5).attr("y",h.sampleHeight()/2).text(t=>t),f=[0];n.each(function(){f[0]<this.getBoundingClientRect().width&&(f[0]=this.getBoundingClientRect().width)}),o-2*d-5<f[0]&&(i=(o-2*d-5)/f[0],n.attr("font-size",d3.max([(h.sampleHeight()-5)*i,10])))},h.update=function(){o()},h}function x(){function e(){return r.height()-(r.paddings().top+r.paddings().bottom)}function a(){return r.width()-(r.paddings().right+r.paddings().left)}var r=h().add_property("width",500,v("number_nonneg","width")).add_property("height",500,v("number_nonneg","height")).add_property("paddings",{top:35,right:10,bottom:50,left:50},function(t){if("function"!=typeof t){if(void 0===t.top)throw"Error in 'typeCheck' for property 'paddings': top-padding is not defined";if(void 0===t.left)throw"Error in 'typeCheck' for property 'paddings': left-padding is not defined";if(void 0===t.bottom)throw"Error in 'typeCheck' for property 'paddings': bottom-padding is not defined";if(void 0===t.right)throw"Error in 'typeCheck' for property 'paddings': right-padding is not defined"}return t}).add_property("title","").add_property("titleX",function(){return r.width()/2},v("number_nonneg","titleX")).add_property("titleY",function(){return d3.min([22,.9*r.paddings().top])},v("number_nonneg","titleY")).add_property("titleSize",function(){return d3.min([20,.8*r.paddings().top])},v("number_nonneg","titleSize")).add_property("transitionDuration",1e3,v("number_nonneg","transitionDuration")).add_property("on_marked",function(){}).add_property("showPanel",!0).add_property("clickSingle",!0).add_property("showLegend",!0).add_property("plotWidth",void 0,v("number_nonneg","plotWidth")).add_property("plotHeight",void 0,v("number_nonneg","plotHeight")),n=(r.legend=i(r),r.plotWidth(a).plotHeight(e),r.wrapSetter("width",function(t){return function(){return r.get_plotWidth=a,t.apply(r,arguments)}}),r.wrapSetter("height",function(t){return function(){return r.get_plotHeight=e,t.apply(r,arguments)}}),r.wrapSetter("plotWidth",function(t){return function(){return r.get_width=function(){return t()+r.paddings().left+r.paddings().right},t.apply(r,arguments)}}),r.wrapSetter("plotHeight",function(t){return function(){return r.get_height=function(){return t()+r.paddings().top+r.paddings().bottom},t.apply(r,arguments)}}),!1),o={mode:!(r.selectMode=function(t){return null==t?n:(n=t=1==t,r)}),down:void 0};return r.pan=function(t,e){return null==e?o[t]:(o[t]=e,r)},r.set_paddings=function(t){return void 0===t.top&&(t.top=r.paddings().top),void 0===t.bottom&&(t.bottom=r.paddings().bottom),void 0===t.left&&(t.left=r.paddings().left),void 0===t.right&&(t.right=r.paddings().right),r.paddings(t),r},r.put_static_content=function(t){r.container=t.append("div").style("position","relative").attr("class","linked-charts"),r.container.node().ondragstart=function(){return!1},r.svg=r.container.append("table").attr("class","mainTable").append("tr").append("td").append("svg"),void 0===r.legend.container()&&r.legend.container(r.container.selectAll("tr").append("td").attr("id","legend")),r.container.append("div").attr("class","inform hidden").append("p").attr("class","value"),r.svg.append("text").attr("class","title plainText").attr("text-anchor","middle"),r.svg.append("svg").attr("class","plotArea"),r.showPanel()&&(null==r.panel&&(r.panel=l(r),r.panel.put_static_content()),r.panel.add_button("Save plot as png","#save",d),r.panel.add_button("Save plot as svg","#svg",c),r.panel.add_button("Select elements","#selection",u,"You can also select elements by pressing 'Shift'"),r.panel.add_button("Togle pan mode","#pan",p),r.panel.add_button("Reset scales","#home",function(t){t.resetDomain()},"You can also use double click to reset scales"),r.panel.add_button("Fit selected","#fitSelected",b))},r.mark=function(t,e){return"__clear__"==t?(r.svg.selectAll(".data_element.marked").classed("marked",!1),r.svg.selectAll(".data_element").attr("opacity",1).style("filter","none"),e||r.on_marked()):(t.empty||(t=r.get_elements(t)),r.svg.selectAll(".data_element.marked").empty()&&r.svg.selectAll(".data_element").attr("opacity",.3).style("filter","saturate(0.3) brightness(0.3)"),t.classed("switch",!0),t.size()<2&&t.filter(function(){return d3.select(this).classed("marked")}).classed("switch",!1).classed("marked",!1).attr("opacity",.3).style("filter","saturate(0.3) brightness(0.3)"),t.filter(function(){return d3.select(this).classed("switch")}).classed("marked",!0).classed("switch",!1).attr("opacity",1).style("filter","none"),r.svg.selectAll(".data_element.marked").empty()&&r.svg.selectAll(".data_element").attr("opacity",1).style("filter","none"),e||r.on_marked()),r},r.place=function(t){if("string"==typeof(t=void 0===t?"body":t)){var e=t;if(0==(t=d3.selectAll(e)).size())throw"Error in function 'place': DOM selection for string '"+e+"' did not find a node."}return r.transitionOff=!0,r.put_static_content(t),r.update(),r.transitionOff=!1,r},r.updateSize=function(){var t;return(0<r.transitionDuration()&&!r.transitionOff?(t=d3.transition("size").duration(r.transitionDuration()),r.svg.transition(t).attr("width",r.width()).attr("height",r.height()),r.svg.selectAll(".title").transition(t).attr("font-size",r.titleSize()).attr("x",r.titleX()).attr("y",r.titleY()),r.svg.selectAll(".plotArea").transition(t)):(r.svg.attr("width",r.width()).attr("height",r.height()),r.svg.selectAll(".title").attr("font-size",r.titleSize()).attr("x",r.titleX()).attr("y",r.titleY()),r.svg.selectAll(".plotArea"))).attr("x",r.paddings().left).attr("y",r.paddings().top).attr("width",r.plotWidth()).attr("height",r.plotHeight()),r.showPanel()&&r.panel.updateSize(),r},r.updateTitle=function(){return r.svg.selectAll(".title").text(r.title()),r},r.get_elements=function(t){return t=(t=t.splice?t:[t]).map(function(t){return _(t).replace(/[ .]/g,"_")}),r.svg.selectAll("#p"+t.join(", #p"))},r.update=function(){return r.updateSize(),r.updateTitle(),r.showLegend()&&0<r.legend.get_nblocks()&&r.legend.update(),r},r}function d(a){for(var o=document.createElement("canvas"),t=(void 0===a.legend?(o.height=a.svg.attr("height"),o.width=a.svg.attr("width")):(o.height=d3.max([a.height(),a.legend.height()]),o.width=a.width()+a.legend.width()),o.getContext("2d")),e=a.container.selectAll("canvas").filter(function(){return d3.select(this).classed("active")}).nodes(),r=0;r<e.length;r++)t.drawImage(e[r],a.paddings().left,a.paddings().top);a.svg.selectAll("text").attr("fill","black");for(var n,l,i,s,d,c,u,p,g,f=a.svg.node().cloneNode(!0),r=0;r<f.childNodes.length;r++)"panel_g"==f.childNodes[r].classList[0]&&f.removeChild(f.childNodes[r]);n=f,l=o.getContext("2d"),i=function(){for(var t=o.toDataURL("image/png"),e=atob(t.substring("data:image/png;base64,".length)),a=new Uint8Array(e.length),r=0,n=e.length;r<n;++r)a[r]=e.charCodeAt(r);t=new Blob([a.buffer],{type:"image/png"});saveAs(t,"export_"+Date.now()+".png")},s=a.legend,p=void(g=0)!==s?(d=0,p="<g>"+n.innerHTML+"</g>",s.container().selectAll("tr").each(function(t,e){g=0,u=[],d3.select(this).selectAll("td").each(function(t,e){c=d3.select(this).selectAll("svg"),p+="<g transform='translate("+(s.chart.width()+g)+", "+(d+a.paddings().top)+")'>"+c.node().innerHTML+"</g>",u.push(c.attr("height")),g+=+c.attr("width")}),d+=+d3.max(u)}),"<svg xmlns='http://www.w3.org/2000/svg' width='"+(a.width()+g)+"' height='"+a.height()+"'>"+p+"</svg>"):(new XMLSerializer).serializeToString(n),(n=new Image).onload=function(){l.drawImage(this,0,0),a.canvas&&a.canvas.classed("active")&&l.drawImage(a.canvas.node(),a.paddings().left,a.paddings().top),i()},n.src="data:image/svg+xml; charset=utf8, "+encodeURIComponent(p)}function c(t){for(var e,a,r,n,o,l,i=t.svg.node().cloneNode(!0),s=0;s<i.childNodes.length;s++)"panel_g"==i.childNodes[s].classList[0]&&i.removeChild(i.childNodes[s]);t.container.selectAll("canvas").filter(function(){return d3.select(this).classed("active")}).empty()?(o=void 0!==t.legend?(a=0,o="<g>"+i.innerHTML+"</g>",t.legend.container().selectAll("tr").each(function(){e=0,n=[],d3.select(this).selectAll("td").each(function(){r=d3.select(this).selectAll("svg"),o+="<g transform='translate("+(t.width()+e)+", "+(a+t.paddings().top)+")'>"+r.node().innerHTML+"</g>",n.push(r.attr("height")),e+=+r.attr("width")}),a+=+d3.max(n)}),"<svg xmlns='http://www.w3.org/2000/svg'>"+o+"</svg>"):t.svg.attr("xmlns","http://www.w3.org/2000/svg").node().parentNode.innerHTML,l=new Blob([o],{type:"image/svg+xml"}),saveAs(l,"export_"+Date.now()+".svg")):(t.container.append("div").attr("class","hint").attr("id","errMessage").style("left",t.width()/3+"px").style("top",t.height()/3+"px").style("width",t.width()/3+"px").text("Chart in canvas mode cannot be saved as SVG."),setTimeout(function(){t.container.select("#errMessage").remove()},2e3))}function u(t,e){e.classed("clicked")?(e.classed("clicked",!1).attr("opacity",.6).on("mouseout",function(){d3.select(this).attr("opacity",.6)}),t.selectMode(!1)):(e.classed("clicked",!0).attr("opacity",1).on("mouseout",function(){}),t.selectMode(!0),(e=t.panel.g.selectAll("#b_pan")).classed("clicked")&&e.on("click").call(e.node(),e.datum()))}function p(t,e){e.classed("clicked")?(e.classed("clicked",!1).attr("opacity",.6).on("mouseout",function(){d3.select(this).attr("opacity",.6)}),t.pan("mode",!1)):(e.classed("clicked",!0).attr("opacity",1).on("mouseout",function(){}),t.pan("mode",!0),(e=t.panel.g.selectAll("#b_selection")).classed("clicked")&&e.on("click").call(e.node(),e.datum()))}function b(a){var t=a.get_marked(),e=(0==(t=a.layers?Object.keys(a.layers).map(e=>t[e].map(t=>[e,t])).flat():t).length&&(t=a.layers?Object.keys(a.layers).map(e=>a.get_layer(e).elementIds().map(t=>[e,t])).flat():a.elementIds()),{x:[],y:[]}),r=(t.map(function(t){t=a.get_position(t);t&&(e.x.push(t[0]),e.y.push(t[1]))}),d3.extent(e.x)),n=d3.extent(e.y);a.zoom([r[0],n[0]],[r[1],n[1]])}function n(){function t(r){return function(){var e;if(u["get_singleScale"+r]()){var t=!0;for(a in u.layers)t=t&&u.get_layer(a)["get_contScale"+r]();if(t)for(var a in u.layers)void 0!==u.get_layer(a)["get_layerDomain"+r]()&&(void 0===e?e=u.get_layer(a)["get_layerDomain"+r]():(e[0]=d3.min([e[0],u.get_layer(a)["get_layerDomain"+r]()[0]]),e[1]=d3.max([e[1],u.get_layer(a)["get_layerDomain"+r]()[1]])));else for(var a in u.layers)void 0!==u.get_layer(a)["get_layerDomain"+r]()&&(e=void 0===e?u.get_layer(a)["get_layerDomain"+r]():e.concat(u.get_layer(a)["get_layerDomain"+r]().filter(function(t){return e.indexOf(t)<0})))}return void 0===e&&(e=[0,1]),t&&(u["logScale"+r]()?(e[1]=2*e[1],e[0]=e[0]/2):(e[1]=e[1]+.03*(e[1]-e[0]),e[0]=e[0]-.03*(e[1]-e[0]))),e}}var u=r(),e=(u.add_property("singleScaleX",!0).add_property("singleScaleY",!0).add_property("domainX",void 0,v("array","domainX")).add_property("domainY",void 0,v("array","domainY")).add_property("aspectRatio",void 0,v("number_nonneg","aspectRatio")).add_property("axisTitleX","").add_property("axisTitleY","").add_property("axisTitlePos",{x:{across:"up",along:"end"},y:{across:"up",along:"end"}},function(t){var e={x:{across:"up",along:"end"},y:{across:"up",along:"end"}};if(t.x){if(!t.x.split)throw"Error in 'typeCheck' for property 'axisTitlePos': 'x' must be a string.";var a=t.x.split(" ").map(t=>t.toLowerCase());-1<a.indexOf("down")&&(e.x.across="down"),-1<a.indexOf("middle")&&(e.x.along="middle"),-1<a.indexOf("start")&&(e.x.along="start")}if(t.y){if(!t.y.split)throw"Error in 'typeCheck' for property 'axisTitlePos': 'y' must be a string.";a=t.y.split(" ").map(t=>t.toLowerCase());-1<a.indexOf("down")&&(e.y.across="down"),-1<a.indexOf("middle")&&(e.y.along="middle"),-1<a.indexOf("start")&&(e.y.along="start")}return e}).add_property("ticksX",void 0).add_property("ticksY",void 0).add_property("ticksRotateX",0,function(t){if(isNaN(t))throw"Error in 'typeCheck' for property 'ticksRotateX': the value is not a number.";return t%91}).add_property("ticksRotateY",0,function(t){if(isNaN(t))throw"Error in 'typeCheck' for property 'ticksRotateY': the value is not a number.";return t%91}).add_property("logScaleX",!1).add_property("logScaleY",!1).add_property("on_clickPosition",function(t,e){}),u.axes={},u.get_domainX=t("X"),u.get_domainY=t("Y"),u.domainX=function(t){return"reset"==t?u.domainX(u.origDomainX):("function"==typeof t&&(u.get_domainX=t),t.splice&&(u.get_domainX=function(){return t})),u},u.domainY=function(t){return"reset"==t?u.domainY(u.origDomainY):("function"==typeof t&&(u.get_domainY=t),t.splice&&(u.get_domainY=function(){return t})),u},u.get_position=function(t){return u.get_layer(t[0]).get_position(t[1])},u.zoom=function(t,e){if(t[0]!=e[0]&&t[1]!=e[1]){if(u.axes.scale_x.invert)u.domainX([u.axes.scale_x.invert(t[0]),u.axes.scale_x.invert(e[0])]);else{for(var a=[],r=u.get_domainX(),n=0;u.axes.scale_x(r[n])<=e[0];)u.axes.scale_x(r[n])>=t[0]&&a.push(r[n]),n++;0<a.length&&u.domainX(a)}if(u.axes.scale_y.invert)u.domainY([u.axes.scale_y.invert(e[1]),u.axes.scale_y.invert(t[1])]);else{for(var o=[],l=u.get_domainY(),n=0;u.axes.scale_y(l[n])>=t[1];)u.axes.scale_y(l[n])<=e[1]&&o.push(l[n]),n++;0<o.length&&u.domainY(o)}u.updateAxes()}},u.resetDomain=function(){u.domainX("reset"),u.domainY("reset"),u.updateAxes()},u.put_static_content),a=(u.put_static_content=function(t){e(t);t=u.svg.append("g").attr("class","axes_g");u.axes.x_g=t.append("g").attr("class","x axis"),u.axes.x_label=u.axes.x_g.append("text").attr("class","label"),u.axes.y_g=t.append("g").attr("class","y axis"),u.axes.y_label=u.axes.y_g.append("text").attr("class","label").attr("transform","rotate(-90)"),u.origDomainY=u.get_domainY,u.origDomainX=u.get_domainX,u.showPanel()&&(u.panel.add_button("Zoom in","#zoomIn",function(t){var e,a=t.axes.scale_x.domain(),r=t.axes.scale_y.domain();2==a.length&&"number"==typeof a[0]&&(a[1],1)?t.domainX([(4*a[0]+a[1])/5,(a[0]+4*a[1])/5]):(e=Math.ceil(.1*a.length),a.splice(0,e),a.splice(a.length-e),0<a.length&&t.domainX(a)),2==r.length&&"number"==typeof r[0]&&(r[1],1)?t.domainY([(4*r[0]+r[1])/5,(r[0]+4*r[1])/5]):(e=Math.ceil(.1*r.length),r.splice(0,e),r.splice(r.length-e),0<r.length&&t.domainY(r)),t.updateAxes()},"Double click to return to original scales"),u.panel.add_button("Zoom out","#zoomOut",function(t){var e=t.axes.scale_x.domain(),a=t.axes.scale_y.domain();if(2==e.length&&"number"==typeof e[0]&&(e[1],1))t.domainX([(6*e[0]-e[1])/5,(-e[0]+6*e[1])/5]);else{for(var r=Math.ceil(.1*e.length),n=t.origDomainX(),o=n.indexOf(e[0]),l=n.indexOf(e[e.length-1]),i=o-1;i>=d3.max([0,o-r]);i--)e.unshift(n[i]);for(i=l+1;i<d3.min([n.length,l+r+1]);i++)e.push(n[i]);t.domainX(e)}if(2==a.length&&"number"==typeof a[0]&&(a[1],1))t.domainY([(6*a[0]-a[1])/5,(-a[0]+6*a[1])/5]);else{for(var r=Math.ceil(.1*a.length),s=t.origDomainY(),o=s.indexOf(a[0]),l=s.indexOf(a[a.length-1]),i=s[o-1];i>=d3.max([0,o-r]);i--)a.unshift(s[i]);for(i=l+1;i<d3.min([s.length,l+r+1]);i++)a.push(s[i]);t.domainY(a)}t.updateAxes()},"Double click to return to original scales"))},u.updateSize);u.updateSize=function(){var t;return a(),(0<u.transitionDuration()&&!u.transitionOff?(t=d3.transition("size").duration(u.transitionDuration()),u.svg.selectAll(".axes_g").transition(t).attr("transform","translate("+u.paddings().left+", "+u.paddings().top+")"),u.axes.x_g.transition(t)):(u.svg.selectAll(".axes_g").attr("transform","translate("+u.paddings().left+", "+u.paddings().top+")"),u.axes.x_g)).attr("transform","translate(0,"+u.get_plotHeight()+")"),u.updateAxes(),u};function p(t){var e={tickValues:null,tickFormat:null},a=u["ticks"+t]();if(a){if(void 0===a.splice)throw"Error in 'get_ticks': new tick values and labels should be passed as an array";void 0===a[0].splice&&(a=[a]);for(var r=1;r<a.length;r++)if(a[0].length!=a[r].length)throw"Error in 'get_ticks': the amount of tick labels must be equal to the amount of tick values";if(e.tickValues=a[0],1==a.length)return e;for(var n=2<a.length,o=1;n&&o<a.length-1;){for(r=0;n&&r<a[o].length;)n=a[o][r]==a[o+1][r],r++;o++}n&&a.splice(2);var l=[];if(2<a.length)for(r=0;r<a[0].length;r++){for(var i="",o=1;o<a.length;o++)i+="<tspan x = 0.5 dy = 1.1em",a.colour?i+=" fill = '"+a.colour[o-1]+"'>":i+=">",i+=a[o][r]+"</tspan>";l.push(i)}else l=a[1];e.tickFormat=function(t){return l[e.tickValues.indexOf(t)]}}return e}function g(t){var e=u["get_domain"+t]();void 0===u.axes["scale_"+t.toLowerCase()]&&(u.axes["scale_"+t.toLowerCase()]={},u.axes["shiftScale"+t]=d3.scaleLinear().domain([0,1])),2==e.length&&"number"==typeof(e[0]+e[1])?((e=u["logScale"+t]())&&0<e&&1!=e?(void 0===u.axes["scale_"+t.toLowerCase()].base&&(u.axes["scale_"+t.toLowerCase()]=d3.scaleLog()),u.axes["scale_"+t.toLowerCase()].base(e)):void 0!==u.axes["scale_"+t.toLowerCase()].clamp&&null==u.axes["scale_"+t.toLowerCase()].base||(u.axes["scale_"+t.toLowerCase()]=d3.scaleLinear()),u.axes["scale_"+t.toLowerCase()].nice()):void 0===u.axes["scale_"+t.toLowerCase()].padding&&(u.axes["scale_"+t.toLowerCase()]=d3.scalePoint().padding(.3))}function f(t){return 2==(t=u["get_domain"+t]()).length&&"number"==typeof t[0]&&"number"==typeof t[1]&&t[0]==t[1]&&(t[0]=t[0]-.5,t[1]=t[1]+.5),t}function h(t){var e=[0],a=u.axes["scale_"+t.toLowerCase()];a.padding&&e.push(a(a.domain()[1])-a(a.domain()[0])||a(a.domain()[0])),a.base&&e.push(a(u["logScale"+t]())-a(1)),a.clamp&&!a.base&&e.push(a(1)-a(0)),u.axes["shiftScale"+t].range(e)}u.panMove=function(t){var e,a,r,n,o,l,i=u.axes.scale_x.domain(),s=u.axes.scale_y.domain();u.axes.scale_x.invert?(e=u.axes.scale_x.invert(t[0])-u.axes.scale_x.invert(u.pan("down")[0]),u.pan("down")[0]=t[0],n=[i[0]-e,i[1]-e],u.logScaleX()&&(n[0]<=0&&(n[0]=i[0]),n[1]<=0)&&(n[1]=i[1]),u.domainX(n)):(e=t[0]-u.pan("down")[0],0<(r=Math.floor(Math.abs(e)/u.axes.scale_x.step()*2))&&(u.pan("down")[0]+=Math.sign(e)*r*u.axes.scale_x.step()/2,o=(n=u.origDomainX()).indexOf(i[0]),l=n.indexOf(i[i.length-1]),0<(i=e<0?(i.splice(0,r),i.concat(n.slice(l+1,d3.min([n.length,l+r+1])))):(i.splice(i.length-r),n.slice(d3.max([0,o-r]),o).concat(i))).length)&&u.domainX(i)),u.axes.scale_y.invert?(a=u.axes.scale_y.invert(t[1])-u.axes.scale_y.invert(u.pan("down")[1]),u.pan("down")[1]=t[1],e=[s[0]-a,s[1]-a],u.logScaleY()&&(e[0]<=0&&(e[0]=s[0]),e[1]<=0)&&(e[1]=s[1]),u.domainY(e)):(a=t[1]-u.pan("down")[1],0<(r=Math.floor(Math.abs(a)/u.axes.scale_y.step()*2))&&(u.pan("down")[1]+=Math.sign(a)*r*u.axes.scale_y.step()/2,o=(n=u.origDomainY()).indexOf(s[0]),l=n.indexOf(s[s.length-1]),0<(s=0<a?(s.splice(0,r),s.concat(n.slice(l+1,d3.min([n.length,l+r+1])))):(s.splice(s.length-r),n.slice(d3.max([0,o-r]),o).concat(s))).length)&&u.domainY(s)),u.updateAxes()};return u.updateAxesTitles=function(){var t,e={x:{x:5,y:-5,anchor:"start",dy:0},y:{x:0,y:6,anchor:"end",dy:"1.8ex"}};return"middle"==u.axisTitlePos().x.along&&(e.x.x=u.plotWidth()/2,e.x.anchor="middle"),"end"==u.axisTitlePos().x.along&&(e.x.x=u.plotWidth(),e.x.anchor="end"),"down"==u.axisTitlePos().x.across&&(u.axes.x_label.text(""),e.x.y=u.axes.x_g.node().getBBox().height,e.x.dy="1.8ex"),"middle"==u.axisTitlePos().y.along&&(e.y.x=-u.plotHeight()/2,e.y.anchor="middle"),"start"==u.axisTitlePos().y.along&&(e.y.x=-u.plotHeight(),e.y.anchor="start"),"down"==u.axisTitlePos().y.across&&(u.axes.y_label.text(""),e.y.y=-u.axes.y_g.node().getBBox().width,e.y.dy=-6),u.axes.x_label.html(u.axisTitleX()),u.axes.y_label.html(u.axisTitleY()),(0<u.transitionDuration()&&!u.transitionOff?(t=d3.transition("axes").duration(u.transitionDuration()),u.axes.x_label.transition(t).attr("x",e.x.x).attr("y",e.x.y).attr("dy",e.x.dy).style("text-anchor",e.x.anchor),u.axes.y_label.transition(t)):(u.axes.x_label.attr("x",e.x.x).attr("y",e.x.y).attr("dy",e.x.dy).style("text-anchor",e.x.anchor),u.axes.y_label)).attr("x",e.y.x).attr("y",e.y.y).attr("dy",e.y.dy).style("text-anchor",e.y.anchor),u},u.updateAxes=function(){function t(){u.axes.x_g.selectAll(".tick").selectAll("text").html(d.tickFormat)}function e(){u.axes.y_g.selectAll(".tick").selectAll("text").html(c.tickFormat)}g("X"),g("Y"),u.axes.scale_x.range([0,u.get_plotWidth()]),u.axes.scale_y.range([u.get_plotHeight(),0]),u.axes.scale_x.domain(f("X")),u.axes.scale_y.domain(f("Y")),u.aspectRatio()&&!u.axes.scale_x.base&&!u.axes.scale_y.base&&u.axes.scale_x.clamp&&u.axes.scale_y.clamp&&(a=u.axes.scale_x,r=u.axes.scale_y,n=u.get_aspectRatio(),l=(a.range()[1]-a.range()[0])/(a.domain()[1]-a.domain()[0]),i=(r.range()[1]-r.range()[0])/(r.domain()[1]-r.domain()[0]),l=Math.abs(l/i),n<l?(o=(a.domain()[1]-a.domain()[0])*(l/n-1)/2,a.domain([a.domain()[0]-o,a.domain()[1]+o])):(o=(r.domain()[1]-r.domain()[0])*(n/l-1)/2,r.domain([r.domain()[0]-o,r.domain()[1]+o]))),h("X"),h("Y");var a,r,n,o,l,i,s,d=p("X"),c=p("Y");0<u.transitionDuration()&&!u.transitionOff?(i=d3.transition("axes").duration(u.transitionDuration()),d3.axisBottom().scale(u.axes.scale_x).tickValues(d.tickValues).tickFormat(d.tickFormat)(u.axes.x_g.transition(i)),d3.axisLeft().scale(u.axes.scale_y).tickValues(c.tickValues).tickFormat(c.tickFormat)(u.axes.y_g.transition(i))):(d3.axisBottom().scale(u.axes.scale_x).tickValues(d.tickValues).tickFormat(d.tickFormat)(u.axes.x_g),d3.axisLeft().scale(u.axes.scale_y).tickValues(c.tickValues).tickFormat(c.tickFormat)(u.axes.y_g)),d.tickFormat&&(0<u.transitionDuration()&&!u.transitionOff?setTimeout(t,u.transitionDuration()):t());for(s in c.tickFormat&&(0<u.transitionDuration()&&!u.transitionOff?setTimeout(e,u.transitionDuration()):e()),u.axes.y_g.selectAll(".tick").selectAll("text").attr("transform","rotate(-"+u.ticksRotateY()+", -9, 0)").style("text-anchor",69<u.ticksRotateY()?"middle":"end").attr("dy",69<u.ticksRotateY()?0:"0.32em"),u.axes.x_g.selectAll(".tick").selectAll("text").attr("transform","rotate(-"+u.ticksRotateX()+")").style("text-anchor",19<u.ticksRotateX()?"end":"middle").attr("dx",19<u.ticksRotateX()?"-.8em":0).attr("dy",19<u.ticksRotateX()?.55-.01*(u.ticksRotateX()-20)+"em":".71em"),u.updateAxesTitles(),u.layers)u.get_layer(s).updateElementPosition();return u},u.clickPosition=function(t){function e(t,e){return t.domain()[Math.round((e-t.padding()*t.step())/t.step())]}var a=u.axes.scale_x.invert?u.axes.scale_x.invert(t[0]):e(u.axes.scale_x,t[0]),t=u.axes.scale_y.invert?u.axes.scale_y.invert(t[1]):e(u.axes.scale_y,u.axes.scale_y.range()[0]-t[1]);return u.get_on_clickPosition(a,t),u},u}function w(t,e){void 0===e&&(e=n()),void 0===t&&(t="layer"+e.get_nlayers());var r=e.create_layer(t).get_layer(t).add_property("lineFun",void 0,function(t){if("function"==typeof t)return t;if("string"==typeof t)return new Function("return "+t)();throw"Error in 'typeCheck' for property 'lineFun': value must be a function ora string that can be evaluated."}).add_property("nsteps",100).add_property("lineWidth",1.5,v("array_fun","lineWidth")).add_property("dasharray",void 0,v("array_fun","dasharray")).add_property("fill","none",v("array_fun","fill"));return e.syncProperties(r),r.nelements(1),r.updateElements=function(){var t=r.g.selectAll(".data_element").data(r.elementIds(),function(t){return t});t.exit().remove(),t.enter().append("path").attr("class","data_element").merge(t).attr("id",function(t){return"p"+(r.id+"_"+t).replace(/[ .]/g,"_")}).on("click",(t,e)=>r.get_on_click(e,t)).on("mouseover",(t,e)=>r.get_on_mouseover(e,t)).on("mouseout",(t,e)=>r.get_on_mouseout(e,t))},r.dresser(function(t){t.attr("stroke",function(t){return r.get_colour(t)}).attr("stroke-width",function(t){return r.get_lineWidth(t)}).attr("stroke-dasharray",function(t){return r.get_dasharray(t)}).attr("opacity",function(t){return r.get_opacity(t)}).attr("fill",function(t){return r.get_fill(t)})}),r.findElements=function(s,d){var t=d3.max([10,2*r.lineWidth()]);return s[0]-d[0]<t&&s[1]-d[1]<t&&(s=[s[0]+t/2,s[1]+t/2],d=[d[0]-t/2,d[1]-t/2]),r.g.selectAll("path").filter(function(){for(var t,e,a,r,n,o=d3.select(this).attr("d").substr(1).split("L").map(function(t){return t.split(",")}),l=!1,i=0;!l&&i<o.length-1;)a=o[i+1][0]-o[i][0],r=o[i][1]-o[i+1][1],n=o[i+1][1]*o[i][0]-o[i][1]*o[i+1][0],(o[i][0]-s[0])*(o[i+1][0]-s[0])<0?(t=-(s[0]*r+n)/a,l=(s[1]-t)*(d[1]-t)<0):(o[i][0]-d[0])*(o[i+1][0]-d[0])<0?(t=-(d[0]*r+n)/a,l=(s[1]-t)*(d[1]-t)<0):(o[i][1]-s[1])*(o[i+1][1]-s[1])<0?(e=-(s[1]*a+n)/r,l=(s[0]-e)*(d[0]-e)<0):(o[i][1]-d[1])*(o[i+1][1]-d[1])<0&&(e=-(d[1]*a+n)/r,l=(s[0]-e)*(d[0]-e)<0),i++;return l}).data()},r.updateElementPosition=function(){var e=d3.line().x(function(t){return r.chart.axes.scale_x(t.x)}).y(function(t){return r.chart.axes.scale_y(t.y)});return 0<r.chart.transitionDuration()&&!r.chart.transitionOff?r.g.selectAll(".data_element").transition("elementPosition").duration(r.chart.transitionDuration()).attr("d",function(t){return e(r.get_data(t))}):r.g.selectAll(".data_element").attr("d",function(t){return e(r.get_data(t))}),r.chart},r.on_mouseover(function(t,e){var a=d3.pointer(e,r.chart.container.node());d3.select(e.target).attr("stroke",function(t){return d3.rgb(r.get_colour(t)).darker(.5)}).classed("hover",!0),r.chart.container.selectAll(".inform").data([t]).style("left",a[0]+10+"px").style("top",a[1]+10+"px").select(".value").html(r.get_informText(t)),r.chart.container.selectAll(".inform").classed("hidden",!1)}),r.on_mouseout(function(t,e){var a=0<r.get_marked().length;d3.select(e.target).attr("stroke",function(t){return a^d3.select(this).classed("marked")?"#aaa":r.get_colour(t)}).classed("hover",!1),r.chart.container.selectAll(".inform").classed("hidden",!0)}),r.colourMarked=function(){var t={};t[r.id]=r.get_marked(),(t=r.chart.get_elements(t)).empty()?r.g.selectAll(".data_element").attr("stroke",function(t){return r.get_colour(t)}):r.g.selectAll(".data_element").attr("stroke",function(t){return d3.select(this).classed("marked")?r.get_colour(t):"#aaa"})},e}function k(t,e){var o=w(t,e).activeLayer();return o.type="xLine",o.get_data=function(t){for(var e=o.layerDomainX(),a=((e=void 0===e?o.chart.axes.scale_x.domain():e)[1]-e[0])/o.get_nsteps(t),r=[],n=e[0];n<e[1];n+=a)r.push({x:n,y:o.get_lineFun(n,t)});return d3.line().x(function(t){return o.chart.axes.scale_x(t.x)}).y(function(t){return o.chart.axes.scale_y(t.y)}),r},o.layerDomainY(function(){if(o.layerDomainX()){for(var t=o.elementIds(),e=[],a=0;a<t.length;a++)e=e.concat(d3.extent(o.get_data(t[a]).map(function(t){return t.y})));return d3.extent(e)}}),o.chart}function S(t,e){var o=w(t,e).activeLayer();return o.type="yLine",o.get_data=function(t){for(var e=o.layerDomainY(),a=((e=void 0===e?o.chart.axes.scale_y.domain():e)[1]-e[0])/o.get_nsteps(t),r=[],n=e[0];n<e[1];n+=a)r.push({y:n,x:o.get_lineFun(n,t)});return d3.line().x(function(t){return o.chart.axes.scale_x(t.x)}).y(function(t){return o.chart.axes.scale_y(t.y)}),r},o.layerDomainX(function(){if(o.layerDomainY()){for(var t=o.elementIds(),e=[],a=0;a<t.length;a++)e=e.concat(d3.extent(o.get_data(t[a]).map(function(t){return t.x})));return d3.extent(e)}}),o.chart}function A(t,e){var o=w(t,e).activeLayer();return o.type="paramCurve",o.add_property("xFunction").add_property("yFunction").add_property("paramRange",[0,1]),o.chart.syncProperties(o),o.get_data=function(t){for(var e=o.paramRange(),a=((e=e[1]<e[0]?[e[1],e[0]]:e)[1]-e[0])/o.get_nsteps(),r=[],n=e[0];n<e[1];n+=a)r.push({x:o.get_xFunction(n,t),y:o.get_yFunction(n,t)});return r},o.layerDomainX(function(){for(var t=o.elementIds(),e=[],a=0;a<t.length;a++)e=e.concat(d3.extent(o.get_data(t[a]).map(function(t){return t.x})));return d3.extent(e)}),o.layerDomainY(function(){for(var t=o.elementIds(),e=[],a=0;a<t.length;a++)e=e.concat(d3.extent(o.get_data(t[a]).map(function(t){return t.y})));return d3.extent(e)}),o.chart}function o(t,e){var r=w(t,e).activeLayer();return r.type="pointLine",r.add_property("x",void 0,v("matrix_fun","x")).add_property("y",void 0,v("matrix_fun","y")),r.chart.syncProperties(r),r.get_data=function(t){for(var e=[],a=0;a<r.nsteps();a++)e.push({x:r.get_x(a,t),y:r.get_y(a,t)});return e},r.layerDomainX(function(){var e=[];return r.elementIds().map(function(e){return d3.extent(d3.range(r.nsteps()).map(function(t){return r.get_x(t,e)}).filter(function(t){return!lc.isNaN(t)}))}).forEach(function(t){e=e.concat(t)}),d3.extent(e)}),r.layerDomainY(function(){var e=[];return r.elementIds().map(function(e){return d3.extent(d3.range(r.nsteps()).map(function(t){return r.get_y(t,e)}).filter(function(t){return!lc.isNaN(t)}))}).forEach(function(t){e=e.concat(t)}),d3.extent(e)}),r.chart}function C(t,l){void 0===l&&(l=n()),void 0===t&&(t="layer"+l.get_nlayers());function e(){return"default"==i.mode()?2500<i.nelements()?"canvas":"svg":i.mode()}var i=l.create_layer(t).get_layer(t).add_property("x",void 0,v("array_fun","x")).add_property("y",void 0,v("array_fun","y")).add_property("size",6,v("array_fun","size")).add_property("stroke",function(t){return d3.rgb(i.get_colour(t)).darker(.8)},v("array_fun","stroke")).add_property("strokeWidth",function(t){return.1*i.get_size(t)},v("array_fun","strokeWidth")).add_property("symbol","Circle",v("array_fun","symbol")).add_property("symbolValue",void 0,v("array_fun","symbolValue")).add_property("symbolLegendTitle","").add_property("shiftX",0,v("array_fun","shiftX")).add_property("shiftY",0,v("array_fun","shiftY"));["X","Y"].forEach(function(e){i.wrapSetter("shift"+e,function(t){return function(){return i["get_scaledShift"+e]=function(t){return i.chart.axes["shiftScale"+e](i["get_shift"+e](t))},t.apply(l,arguments)}})}),l.syncProperties(i),i.type="scatter",i.mode("default"),i.chart.informText(function(t){var e=i.get_x(t),a=i.get_y(t);return e.toFixed&&(e=e.toFixed(2)),a.toFixed&&(a=a.toFixed(2)),"ID: <b>"+i.get_label(t)+"</b>;<br>x = "+e+";<br>y = "+a}),i.nelements(function(){for(var t,e=0;e<1e5;e++){try{t=i.get_x(e)}catch(t){return 0<=e?e:0}if(void 0===t)return 0<=e?e:0}throw"There seem to be very many data points. Please supply a number via 'nelements'."}),i.get_scaledShiftX=function(){return 0},i.get_scaledShiftY=function(){return 0},i.findElements=function(a,r){return i.elementIds().filter(function(t){var e=[i.chart.axes.scale_x(i.get_x(t))+i.get_scaledShiftX(t),i.chart.axes.scale_y(i.get_y(t))+i.get_scaledShiftY(t)];return e[0]-i.get_size(t)-1<=r[0]&&e[1]-i.get_size(t)-1<=r[1]&&e[0]+i.get_size(t)+1>=a[0]&&e[1]+i.get_size(t)+1>=a[1]})},i.get_position=function(t){return[i.chart.axes.scale_x(i.get_x(t))+i.get_scaledShiftX(t),i.chart.axes.scale_y(i.get_y(t))+i.get_scaledShiftY(t)]},i.layerDomainX(function(){var t=i.elementIds().map(function(t){return i.get_x(t)}).filter(function(t){return!lc.isNaN(t)}),e=!0,a=0;if(i.chart.logScaleX())return d3.extent(t.filter(function(t){return 0<t}));for(;e&&a<t.length;)"number"!=typeof t[a]&&(e=!1),a++;return e?d3.extent(t):t}),i.layerDomainY(function(){var t=i.elementIds().map(function(t){return i.get_y(t)}).filter(function(t){return!lc.isNaN(t)}),e=!0,a=0;if(i.chart.logScaleY())return d3.extent(t.filter(function(t){return 0<t}));for(;e&&a<t.length;)"number"!=typeof t[a]&&(e=!1),a++;return e?d3.extent(t):t}),i.resetSymbolScale=function(){for(var t=[],e=i.elementIds(),a=0;a<e.length;a++)-1==t.indexOf(i.get_symbolValue(e[a]))&&t.push(i.get_symbolValue(e[a]));var r;i.symbolScale=d3.scaleOrdinal().domain(t).range(["Circle","Cross","Diamond","Square","Star","Triangle","Wye"]),t[0]&&(i.symbol(function(t){return i.symbolScale(i.get_symbolValue(t))}),i.chart.showLegend())&&((r={})[i.id+"_symbol"]=i.symbolLegendTitle(),i.chart.legend.set_title(r),i.addLegendBlock(i.symbolScale,"symbol",i.id+"_symbol"))};return i.updateElementPosition=function(){var a,r,t;return i.checkMode()&&("svg"==e()?(t=function(t){var e=i.chart.axes.scale_x(i.get_x(t))+i.get_scaledShiftX(t),t=i.chart.axes.scale_y(i.get_y(t))+i.get_scaledShiftY(t);return null==e||null==t||Number.isNaN(e)||Number.isNaN(t)?"translate(-100, 0)":"translate("+e+", "+t+")"},(0<i.chart.transitionDuration()&&!i.chart.transitionOff?i.g.selectAll(".data_element").transition("elementPosition").duration(i.chart.transitionDuration()):i.g.selectAll(".data_element")).attr("transform",t),a=i.chart.axes.scale_x.domain(),r=i.chart.axes.scale_y.domain(),t=i.g.selectAll(".data_element").filter(function(t){return null!=i.chart.axes.scale_x.invert&&(i.get_x(t)>a[1]||i.get_x(t)<a[0])||null!=i.chart.axes.scale_y.invert&&(i.get_y(t)>r[1]||i.get_y(t)<r[0])}).data(),(t=i.g.selectAll(".out_tick").data(t,function(t){return t})).exit().remove(),t.enter().append("rect").attr("class","out_tick").attr("fill",function(t){return i.get_colour(t)}).merge(t).attr("width",function(t){return null!=i.chart.axes.scale_y.invert&&(i.get_y(t)>r[1]||i.get_y(t)<r[0])?4:12}).attr("height",function(t){return null!=i.chart.axes.scale_x.invert&&(i.get_x(t)>a[1]||i.get_x(t)<a[0])?4:12}).attr("x",function(t){return null!=i.chart.axes.scale_x.invert?d3.max([i.chart.axes.scale_x(a[0]),i.chart.axes.scale_x(d3.min([i.get_x(t),a[1]]))-d3.select(this).attr("width")]):i.chart.axes.scale_x(i.get_x(t))}).attr("y",function(t){return null!=i.chart.axes.scale_y.invert?d3.min([i.chart.axes.scale_y(r[0])-d3.select(this).attr("height"),i.chart.axes.scale_y(d3.min([i.get_y(t),r[1]]))]):i.chart.axes.scale_y(i.get_y(t))}).on("mousedown",function(t,e){null!=i.chart.axes.scale_x.invert&&i.chart.domainX([d3.min([a[0],i.get_x(e)]),d3.max([a[1],i.get_x(e)])]),null!=i.chart.axes.scale_y.invert&&i.chart.domainY([d3.min([r[0],i.get_y(e)]),d3.max([r[1],i.get_y(e)])]),i.chart.updateAxes()})):i.updateStarted||i.updateCanvas()),l},i.updateElementStyle=function(){var t;return i.checkMode()&&(i.resetColourScale(),i.resetSymbolScale(),"svg"==e()?(t=i.g.selectAll(".data_element"),(t=0<i.chart.transitionDuration()&&!i.chart.transitionOff&&0==i.get_marked().length?t.transition("elementStyle").duration(i.chart.transitionDuration()):t).attr("d",function(t){return d3.symbol().type(d3["symbol"+i.get_symbol(t)]).size(y(i.get_symbol(t),i.get_size(t)))()}).attr("fill",function(t){return i.get_colour(t)}).attr("stroke",function(t){return i.get_stroke(t)}).attr("stroke-width",function(t){return i.get_strokeWidth(t)}).attr("opacity",function(t){return i.get_opacity(t)}),0!=i.get_marked().length&&i.colourMarked()):i.updateStarted||i.updateCanvas()),l},i.dresser(function(t){t.attr("fill",function(t){return i.get_colour(t)}).attr("r",function(t){return i.get_size(t)})}),i.updateElements=function(){var t;return i.checkMode()&&("svg"==e()?((t=i.g.selectAll(".data_element").data(i.elementIds(),function(t){return t})).exit().remove(),t.enter().append("path").attr("class","data_element").merge(t).attr("id",function(t){return"p"+(i.id+"_"+t).replace(/[ .]/g,"_")}).on("click",(t,e)=>i.get_on_click(e,t)).on("mouseover",(t,e)=>i.get_on_mouseover(e,t)).on("mouseout",(t,e)=>i.get_on_mouseout(e,t))):i.updateStarted||i.updateCanvas()),l},i.updateCanvas=function(){var t,e,a,r=i.elementIds(),n=i.canvas.node().getContext("2d");n.clearRect(0,0,l.plotWidth(),l.plotHeight());for(var o=0;o<r.length;o++)0!=i.marked.length&&-1==i.marked.indexOf(r[o])?n.fillStyle="#aaa":n.fillStyle=i.get_colour(r[o]),n.globalAlpha=i.get_opacity(r[o]),e=i.chart.axes.scale_x(i.get_x(r[o]))+i.get_scaledShiftX(r[o]),a=i.chart.axes.scale_y(i.get_y(r[o]))+ +i.get_scaledShiftY(r[o]),0<=e&&e<=i.chart.plotWidth()&&0<=a&&a<=i.chart.plotHeight()?(n.strokeStyle=i.get_stroke(r[o]),n.lineWidth=i.get_strokeWidth(r[o]),t=d3.symbol().type(d3["symbol"+i.get_symbol(r[o])]).size(y(i.get_symbol(r[o]),i.get_size(r[o])))()):(n.strokeStyle=i.get_colour(r[o]),n.lineWidth=2*i.get_strokeWidth(r[o]),t="M 0 0 L ",e<0?(e=0,t+="15 "):e>i.chart.plotWidth()?(e=i.chart.plotWidth(),t+="-15 "):t+="0 ",a<0?(a=0,t+="15"):a>i.chart.plotHeight()?(a=i.chart.plotHeight(),t+="-15"):t+="0"),n.translate(e,a),t=new Path2D(t),n.stroke(t),n.fill(t),n.translate(-e,-a)},l}function L(t,e){void 0===e&&(e=n()),C(t=void 0===t?"layer"+e.get_nlayers():t,e);var a=e.get_layer(t),r=(a.add_property("valueAxis","y",function(t){if("x"!=t&&"y"!=t&&"function"!=typeof t)throw"Error in 'typeCheck' for 'valueAxis': axis nameshould be 'x' or 'y'";return t}),e.syncProperties(a),a.type="beeswarm",a.updateElementPosition);return a.updateElementPosition=function(){a.valueAxis();var e=d3.beeswarm().data(a.elementIds().filter(function(t){var e="x"==a.valueAxis()?"y":"x";return void 0!==a.chart.axes["scale_"+e](a["get_"+e](t))}).sort(function(t,e){return a["get_"+a.valueAxis()](t)-a["get_"+a.valueAxis()](e)})).distributeOn(function(t){return a.chart.axes["scale_"+a.valueAxis()](a["get_"+a.valueAxis()](t))}).axis(function(t){return"x"==a.valueAxis()?a.chart.axes.scale_y(a.get_y(t)):a.chart.axes.scale_x(a.get_x(t))}).radius(a.size()).arrange();e.res={};for(var t=0;t<e.length;t++)e.res[e[t].datum]=e[t];return"y"==a.valueAxis()?a.get_scaledShiftX=function(t){return e.res[t]?e.res[t].axis-e.res[t].y:-10}:a.get_scaledShiftY=function(t){return e.res[t]?e.res[t].axis-e.res[t].y:-10},r()},e}function M(t,r){void 0===r&&(r=n()),void 0===t&&(t="layer"+r.get_nlayers());var s=r.create_layer(t).get_layer(t).add_property("ngroups",void 0,v("number_nonneg","ngroups")).add_property("groupIds",void 0,v("array","groupIds")).add_property("nbars",void 0,v("number_nonneg","nbars")).add_property("barIds",void 0,v("array","barIds")).add_property("nstacks",void 0,v("number_nonneg","nstacks")).add_property("stackIds",void 0,v("array","stackIds")).add_property("stackLabel",t=>t,v("array_fun","stackLabel")).add_property("groupLabel",t=>t,v("array_fun","groupLabel")).add_property("barLabel",t=>t,v("array_fun","barLabel")).add_property("value",void 0,function(r){if("function"==typeof r)return r;var n;if("object"==typeof r){r.__inds__&&(n=r.__inds__,r.__inds__=null);var t=Object.keys(r);if("object"==typeof r[t[0]]){var e,a=Object.keys(r[t[0]]);if("object"==typeof r[t[0]][a[0]])return e=Object.keys(r[t[0]][a[0]]),"object"==typeof r[t[0]][a[0]][e[0]]?function(t,e,a){return n&&(t=n.indexOf(t)+1),r[t][e][a][0]}:function(t,e,a){return n&&(t=n.indexOf(t)+1),r[t][e][a]}}}throw"Error in 'typeCheck' for property 'value': the value is not an array or an object."}).add_property("groupWidth",.6).add_property("stroke","#444").add_property("strokeWidth",0);return s.chart.syncProperties(s),s.type="barchart",s.chart.informText(function(t,e,a){var r=s.get_groupLabel(t),n=s.get_barLabel(e),o=s.get_stackLabel(a);return 1<s.nbars()&&(r+=", "+n),1<s.nstacks()&&(r+=", "+o),"ID: <b>"+r+"</b>;<br>value = "+s.get_value(t,e,a).toFixed(2)}),["group","bar","stack"].forEach(function(e){s.wrapSetter("n"+e+"s",function(t){return function(){return s["get_"+e+"Ids"]=function(){return d3.range(t())},t.apply(s,arguments)}}),s.wrapSetter(e+"Ids",function(t){return function(){return s["get_n"+e+"s"]=function(){return t().length},t.apply(s,arguments)}})}),s.nbars(1),s.nstacks(1),s.contScaleX(!1),s.elementIds(function(){if(void 0===s.groupIds()||0==s.groupIds().length)return[];if(1==s.nbars()&&(0==s.barIds()[0]||1==s.barIds()[0]))return s.stackIds();for(var t=[],e=s.barIds(),a=s.stackIds(),r=0;r<s.nbars();r++)for(var n=0;n<s.nstacks();n++)t.push(e[r]+"__,__"+a[n]);return t}),s.colourValue(function(t){var e=[];return(t.split?(1==(e=t.split("__,__")).length&&(e[0]=s.get_stackLabel(e[0])),2==e.length&&(e[0]=s.get_barLabel(e[0]),e[1]=s.get_stackLabel(e[1])),1!=s.nstacks()||0!=s.stackIds()[0]&&1!=s.stackIds()[0]?e.join(", "):e[0]):t).toString()}),s.colour(function(t,e,a){return 1!=s.nbars()||0!=e&&1!=e?s.colourScale(s.get_colourValue(e+"__,__"+a)):s.colourScale(s.get_colourValue(a))}),s.addColourScaleToLegend(!0),s.layerDomainX(function(){var t=s.groupIds().map(t=>s.get_groupLabel(t));return s.contScaleX()?[d3.min(t),d3.max(t)]:t}),s.layerDomainY(function(){for(var t=s.barIds(),e=s.groupIds(),a=s.stackIds(),r=0,n=0;n<s.ngroups();n++)for(var o=0;o<s.nbars();o++){for(var l=0,i=0;i<s.nstacks();i++)l+=s.get_value(e[n],t[o],a[i]);r<l&&(r=l)}return[0,r]}),s.on_mouseover(function(t,e){var a=d3.pointer(e,r.container.node());d3.select(e.target).attr("fill",function(t){return d3.rgb(s.get_colour(t[0],t[1],t[2])).darker(.5)}).classed("hover",!0),s.chart.container.select(".inform").style("left",a[0]+10+"px").style("top",a[1]+10+"px").select(".value").html(s.get_informText(t[0],t[1],t[2])),s.chart.container.select(".inform").classed("hidden",!1)}),s.on_mouseout(function(t,e){var a=0<s.get_marked().length;d3.select(e.target).attr("fill",function(t){return a^d3.select(e.target).classed("marked")?"#aaa":s.get_colour(t[0],t[1],t[2])}).classed("hover",!1),s.chart.container.select(".inform").classed("hidden",!0)}),s.findElements=function(n,o){return s.g.selectAll(".data_element").filter(function(){var t=+d3.select(this).attr("x"),e=+d3.select(this).attr("y"),a=+d3.select(this).attr("width"),r=+d3.select(this).attr("height");return n[0]<=t+a&&o[0]>t&&n[1]<=e+r&&o[1]>e}).data()},s.get_position=function(t){return[s.g.select("#p"+t.join("_")).attr("x"),s.g.select("#p"+t.join("_")).attr("y")]},s.updateElementPosition=function(){var t,e,a,r,n,o;return void 0!==s.groupIds()&&(t=s.groupIds().map(t=>s.get_groupLabel(t)),e=(t=s.contScaleX()?Math.abs(s.chart.axes.scale_x(t[1])-s.chart.axes.scale_x(t[0]))*s.groupWidth():s.chart.axes.scale_x.step()*s.groupWidth())/s.nbars(),a=Math.abs(s.chart.axes.scale_y(1)-s.chart.axes.scale_y(0)),r=d3.scaleLinear().domain([0,s.nbars()-1]).range([-t/2,t/2-e]),n=s.barIds(),o=s.stackIds(),0<s.chart.transitionDuration()&&!s.chart.transitionOff?s.g.selectAll(".data_element").transition("elementPosition").duration(s.chart.transitionDuration()).attr("width",e).attr("height",function(t){return s.get_value(t[0],t[1],t[2])*a}).attr("x",function(t){return null==s.chart.axes.scale_x(s.get_groupLabel(t[0]))?-500:r(n.indexOf(t[1]))+s.chart.axes.scale_x(s.get_groupLabel(t[0]))}).attr("y",function(t){for(var e=0,a=0;a<=o.indexOf(t[2]);a++)e+=s.get_value(t[0],t[1],o[a]);return s.chart.axes.scale_y(e)}):s.g.selectAll(".data_element").attr("width",e).attr("height",function(t){return s.get_value(t[0],t[1],t[2])*a}).attr("x",function(t){return null==s.chart.axes.scale_x(s.get_groupLabel(t[0]))?-500:r(n.indexOf(t[1]))+s.chart.axes.scale_x(s.get_groupLabel(t[0]))}).attr("y",function(t){for(var e=0,a=0;a<=o.indexOf(t[2]);a++)e+=s.get_value(t[0],t[1],o[a]);return s.chart.axes.scale_y(e)})),s},s.updateElementStyle=function(){s.resetColourScale();var t=s.g.selectAll(".data_element");(t=0<s.chart.transitionDuration()&&!s.chart.transitionOff&&0==s.get_marked().length?t.transition("elementStyle").duration(s.chart.transitionDuration()):t).attr("fill",function(t){return s.get_colour(t[0],t[1],t[2])}).attr("stroke",function(t){return s.get_stroke(t[0],t[1],t[2])}).attr("stroke-width",function(t){return s.get_strokeWidth(t[0],t[1],t[2])}).attr("opacity",function(t){return s.get_opacity(t[0],t[1],t[2])}),0!=s.get_marked().length&&s.colourMarked()},s.updateElements=function(){if(void 0===s.groupIds())return s;var t=s.g.selectAll(".group").data(s.groupIds(),function(t){return t}),t=(t.exit().remove(),t.enter().append("g").attr("class","group"),s.g.selectAll(".group").selectAll(".bar").data(function(e){return s.barIds().map(function(t){return[e,t]})},function(t){return t})),t=(t.exit().remove(),t.enter().append("g").attr("class","bar"),s.g.selectAll(".group").selectAll(".bar").selectAll(".data_element").data(function(e){return s.stackIds().map(function(t){return e.concat(t)})},function(t){return t}));t.exit().remove(),t.enter().append("rect").attr("class","data_element").merge(t).attr("id",function(t){return"p"+s.id+"_"+t.join("_").replace(/[ .]/g,"_")}).on("click",function(t,e){s.get_on_click(e[0],e[1],e[2],t)}).on("mouseover",(t,e)=>s.get_on_mouseover(e,t)).on("mouseout",(t,e)=>s.get_on_mouseout(e,t))},s.colourMarked=function(){var t={};t[s.id]=s.get_marked(),(t=s.chart.get_elements(t)).empty()?s.g.selectAll(".data_element").attr("fill",function(t){return s.get_colour(t[0],t[1],t[2])}):s.g.selectAll(".data_element").attr("fill",function(t){return d3.select(this).classed("marked")?s.get_colour(t[0],t[1],t[2]):"#aaa"})},s.chart}function r(){function a(e){return function(){if(l.get_activeLayer()[e])return l.get_activeLayer()[e].apply(l,arguments);for(var t in l.layers)if(l.layers[t][e])return l.layers[t][e].apply(l,arguments)}}var l=x().add_property("activeLayer",void 0).add_property("layerIds",function(){return Object.keys(l.layers)},v("array","layerIds")).add_property("layerType",function(t){return l.get_layer(t).type},v("array_fun","layerType")).add_property("globalColourScale",!0),n=(l.layers={},l.syncProperties=function(t){for(var e=0;e<t.propList.length;e++)void 0===l[t.propList[e]]&&(l[t.propList[e]]=a(t.propList[e]),l["get_"+t.propList[e]]=a("get_"+t.propList[e]))},l.get_nlayers=function(){return Object.keys(l.layers).length},l.get_layer=function(t){if(-1==Object.keys(l.layers).indexOf(t))throw"Error in 'get_layer': layer with id "+t+" is not defined";return l.layers[t]},l.create_layer=function(t){var e=s(t=void 0===t?"layer"+l.get_nlayers():t);return(e.chart=l).layers[t]=e,l.activeLayer(l.get_layer(t)),l},l.add_layer=function(t){var e;void 0===t&&(t="layer"+l.get_nlayers());try{e=l.get_layerType(t)}catch(t){}return void 0===e?l.create_layer(t):("scatter"==e&&C(t,l),"xLine"==e&&k(t,l),"yLine"==e&&S(t,l),"paramCurve"==e&&A(t,l),"bar"==e&&M(t,l),"beeswarm"==e&&L(t,l)),l},l.remove_layer=function(t){if(-1==Object.keys(l.layers).indexOf(t))return-1;for(var e in l.layers[t].legendBlocks)l.legend.removeBlock(l.layers[t].legendBlocks[e]);try{l.layers[t].g.remove(),l.layers[t].canvas.remove()}catch(t){}return delete l.layers[t],0},l.select_layers=function(n){void 0===n&&(n=l.layerIds());for(var t,o={layers:{}},e=0;e<n.length;e++)-1!=l.layerIds().indexOf(n[e])?(void 0===l.layers[n[e]]&&(l.add_layer(n[e]),l.svg)&&l.get_layer(n[e]).put_static_content(),o.layers[n[e]]=l.get_layer(n[e])):(n.splice(e,1),e--);if(0==Object.keys(o.layers).length){for(e in l)o[e]=function(){return o};return o}for(var a=0;a<n.length;a++)for(e=0;e<o.layers[n[a]].propList.length;e++)t=o.layers[n[a]].propList[e],void 0===o[t]&&(o[t]=function(a){return function(t){for(var r="function"!=typeof t?function(){return t}:t,e=0;e<n.length;e++)void 0!==o.layers[n[e]][a]&&o.layers[n[e]][a](function(a){return function(){for(var t=[],e=0;e<arguments.length;e++)t.push(arguments[e]);return t.unshift(a),r.apply(void 0,t)}}(n[e]));return o}}(t));return 0==o.length?l:o},{}),r=(l.globalColourDomain=function(t,e){void 0!==t&&(n[t]=e);var a,r=[];for(a in l.layers)n[a]||(n[a]=l.get_layer(a).colourDomain()),r=r.concat(n[a]);return r.filter(function(t,e,a){return void 0!==t&&a.indexOf(t)===e}),r},l.place_layer=function(t){l.get_layer(t).put_static_content(),l.get_layer(t).update()},l.put_static_content),o=(l.put_static_content=function(t){for(var e in r(t),f(l),l.layers)l.get_layer(e).put_static_content()},l.findElements=function(e,a){var r={};return Object.keys(l.layers).forEach(function(t){r[t]=l.get_layer(t).findElements(e,a)}),r},l.get_elements=function(t){if("object"!=typeof t&&(t=[t]),Array.isArray(t)){if(1!=l.get_nlayers())throw"Error in 'get_elements': layerId is not defined";var e=t;(t={})[Object.keys(l.layers)[0]]=e}var a,r=[],n={};for(a in t)l.get_layer(a).canvas&&l.get_layer(a).canvas.classed("active")?n[a]=t[a]:r=r.concat(t[a].map(function(t){return"object"==typeof t&&(t=t.join("_")),("p"+a+"_"+t).replace(/[ .]/g,"_")}));e=0==r.length?d3.select("_______"):l.svg.selectAll(".chart_g").selectAll("#"+r.join(",#"));return e.canvas=n,e},l.get_marked=function(){var t,e={};for(t in l.layers)e[t]=l.get_layer(t).get_marked();return e},l.mark),i=(l.mark=function(t,e){if(Array.isArray(t))o(t,e);else if(!t.empty||t.canvas&&0!=Object.keys(t.canvas))if("__clear__"==t)for(var a in l.layers)l.get_layer(a).mark(t,e);else for(var a in t=t.canvas?t.canvas:t)l.get_layer(a).mark(t[a],e);else o(t,e)},l.update),e=(l.update=function(){for(var t,e=l.layerIds(),a=0;a<e.length;a++)void 0===l.layers[e[a]]&&l.add_layer(e[a]);for(t in l.layers)-1==e.indexOf(t)?l.remove_layer(t):(l.get_layer(t).updateStarted=!0,l.get_layer(t).updateElements(),l.get_layer(t).updateElementStyle(),l.get_layer(t).updateStarted=!1);return i(),l},l.updateSize);return l.updateSize=function(){for(var t in e(),l.layers)l.get_layer(t).canvas.style("left",l.paddings().left+"px").style("top",l.paddings().top+"px").attr("width",l.plotWidth()).attr("height",l.plotHeight())},l}function I(t,e){for(var a=[],r=[t,e],n=(t=[t.length,e.length]).indexOf(Math.min.apply(null,t)),o=0==n?1:0,l=0;l<r[n].length;l++)-1!=r[o].indexOf(r[n][l])&&a.push(r[n][l]);return a}function O(t,e){this.id=t,this.val=e,this.left=null,this.right=null,this.parent=null,this.height=0,this.x=null,this.val_inds=[t]}function z(e){function i(t){null==t.right&&null==t.left?(t.x=c,c++):(null==t.left.x&&i(t.left),null==t.right.x&&i(t.right),t.x=(t.right.x+t.left.x)/2)}function l(t,e,a){if(null!=t.right&&null!=t.left){e.append("line").attr("x1",a[0](t.left.x)).attr("x2",a[0](t.right.x)).attr("y1",a[1](t.height)).attr("y2",a[1](t.height)).attr("stroke-width",3).attr("id",t.id).attr("orient","h").attr("stroke",d.lineColours()[0]);for(var r=[t.left,t.right],n=0;n<r.length;n++)e.append("line").attr("x1",a[0](r[n].x)).attr("x2",a[0](r[n].x)).attr("y1",a[1](t.height)).attr("y2",a[1](r[n].height)).attr("stroke-width",3).attr("id",r[n].id).attr("orient","v").attr("stroke",d.lineColours()[0]);l(t.left,e,a),l(t.right,e,a)}else{var o;null==t.right&&null==t.left||(o=t.right||t.left,e.append("line").attr("x1",a[0](t.x)).attr("x2",a[0](t.x)).attr("y1",a[1](t.height)).attr("y2",a[1](o.height)).attr("stroke-width",3).attr("id",o.id).attr("orient","v").attr("stroke",d.lineColours()[0]),l(o,e,a))}}function s(l,i,s){i.selectAll("line").on("click",function(t){var e,a,r,n,o;o=l,e=[this.getAttribute("id"),this.getAttribute("orient")],a=i,r=s,o=u(o,e[0]),p(o,o=[]),"h"==e[1]&&e[0],null!=d.heatmap?("horizontal"==d.orientation()&&(n=I(o,d.heatmap.colIds()),d.heatmap.cluster("Row",n),d.heatmap.drawDendogram("Row")),"vertical"==d.orientation()&&(n=I(o,d.heatmap.rowIds()),d.heatmap.cluster("Col",n),d.heatmap.drawDendogram("Col")),d.heatmap.updateLabelPosition()):d.get_on_click(I(o,d.elementIds())),g(a,o,r)})}var d=h().add_property("orientation","horizontal").add_property("height",300).add_property("width",500).add_property("nelements").add_property("elementIds",function(){}).add_property("paddings",{left:20,top:20,bottom:20,right:20}).add_property("distance",function(t,e){return lc.getEuclideanDistance(t,e)}).add_property("data").add_property("lineColours",["black","red"]).add_property("on_click",function(){}),c=(d.wrapSetter("nelements",function(t){return function(){return d.get_elementIds=function(){return d3.range(t())},t.apply(d,arguments)}}),d.wrapSetter("elementIds",function(t){return function(){return d.get_nelements=function(){return t().length},t.apply(d,arguments)}}),d.heatmap=e,d.clusters=void 0,d.set_paddings=function(t){return void 0===t.top&&(t.top=d.paddings().top),void 0===t.bottom&&(t.bottom=d.paddings().bottom),void 0===t.left&&(t.left=d.paddings().left),void 0===t.right&&(t.right=d.paddings().right),d.paddings(t),d},0),u=function(t,e){return null!=t?t.id==e?t:u(t.left,e)||u(t.right,e):null},p=function(t,e){e.push(t.id),null!=t.left&&p(t.left,e),null!=t.right&&p(t.right,e)},g=function(t,e,a,r){t.selectAll("line").attr("stroke",function(t){return function(t,e){for(var a=0;a<e.length;a++)if(e[a]==t)return!0;return!1}(this.id,e)?a[1]:a[0]})},a=(d.cluster=function(){d.get_data("clear");for(var t=d.elementIds(),l=(d.bucket=[],d.elementIds()),e=0;e<t.length;e++)d.bucket[e]=new O(t[e],d.get_data(t[e]));var s=function(t,e){for(var a,r=i[l.indexOf(t[0])][l.indexOf(e[0])],n=0;n<t.length;n++)for(var o=0;o<e.length;o++)r<(a=i[l.indexOf(t[n])][l.indexOf(e[o])])&&(r=a);return r},i=a();d.clusters=function(){d.bucket.length;for(var t=JSON.parse(JSON.stringify(d.bucket));1<t.length;){for(var e=[t[0],t[1]],a=s(t[0].val_inds,t[1].val_inds),r=[0,1],n=0;n<t.length;n++)for(var o=n+1;o<t.length;o++){var l=s(t[n].val_inds,t[o].val_inds);l<a&&(a=l,e=[t[n],t[o]],r=[n,o])}var i=new O(e[0].id+"_"+e[1].id,null);i.left=e[0],i.right=e[1],i.height=a,i.val_inds=i.left.val_inds.concat(i.right.val_inds),r.sort(function(t,e){return e-t}),t.splice(r[0],1),t.splice(r[1],1),t.push(i)}return t[0]}()},function(){for(var t=d.elementIds(),e=new Array(t.length),a=0;a<t.length;a++)e[a]=new Array(t.length);for(a=0;a<t.length;a++)for(var r=a;r<t.length;r++){var n=d.get_distance(d.get_data(t[a]),d.get_data(t[r]));e[a][r]=n,e[r][a]=n}return e}),f=(d.draw=function(){i(d.clusters),c=0,d3.selectAll(d.g.node().childNodes).remove(),"vertical"==d.orientation()?(d.heatmap?(d.width(d.heatmap.height()).height(d.heatmap.paddings().left).paddings({left:d.heatmap.paddings().top,top:0,bottom:0,right:d.heatmap.paddings().bottom}),d.svg.select(".row").attr("transform","translate("+(d.heatmap.paddings().left+ +d.heatmap.plotWidth()+5)+", "+d.heatmap.paddings().top+")").selectAll("text").style("text-anchor","start")):d.svg.attr("width",d.width()).attr("height",d.height()),d.g.attr("transform","rotate(90) translate(0, -"+d.height()+")")):d.heatmap?(d.width(d.heatmap.width()).height(d.heatmap.paddings().top).paddings({top:0,left:d.heatmap.paddings().left,right:d.heatmap.paddings().right,bottom:0}),d.svg.select(".col").attr("transform","translate("+ +d.paddings().left+", "+(d.heatmap.paddings().top+ +d.heatmap.plotHeight()+5)+")").selectAll("text").style("text-anchor","end")):d.svg.attr("width",d.width()).attr("height",d.height());var t,e,a,r,n,o=f();if(void 0!==o)return d.scales=(t=-1,e=0,a=d.paddings(),r=d.elementIds().length,n=(d.width()-a.right-a.left)/r,r=d3.scaleLinear().domain([0,r-1]).range([a.left+n/2,d.width()-a.right-n/2]),"vertical"==d.get_orientation()&&(e=d.height(),t=1),[r,d3.scaleLinear().domain([0,d.clusters.height]).range([d.height()+a.top*t-e,e-a.bottom*t])]),l(o,d.g,d.scales),s(o,d.g,d.lineColours()),d},function(){for(var t=d.elementIds(),e={id:d.clusters.id,left:null,right:null,val_inds:d.clusters.val_inds,x:d.clusters.x,val:d.clusters.val,original:d.clusters,height:d.clusters.height,parent:null},a=function(t,e){0!=t.height&&(t.left&&-1!=t.left.val_inds.indexOf(e)?a(t.left,e):t.right&&-1!=t.right.val_inds.indexOf(e)?a(t.right,e):-1!=t.original.left.val_inds.indexOf(e)?(t.left={id:t.original.left.id,left:null,right:null,val_inds:t.original.left.val_inds,x:t.original.left.x,val:t.original.left.val,original:t.original.left,height:t.original.left.height,parent:t},a(t.left,e)):(t.right={id:t.original.right.id,left:null,right:null,val_inds:t.original.right.val_inds,x:t.original.right.x,val:t.original.right.val,original:t.original.right,height:t.original.right.height,parent:t},a(t.right,e)))},r=0;r<t.length;r++){if(-1==d.clusters.val_inds.indexOf(t[r]))return d.heatmap?void d.remove():(d.cluster(),i(d.clusters),d.clusters);a(e,t[r])}function n(t){null!==t&&(n(t.left),n(t.right),0==t.height?(t.x=l,l++):(t.left&&t.right&&(t.x=(t.left.x+t.right.x)/2),null!=t.parent&&(null==t.left&&(t.x=t.right.x),null==t.right)&&(t.x=t.left.x)))}function o(t){return t.left&&t.right?t:t.left?o(t.left):t.right?o(t.right):void 0}var l=0;n(e);return o(e)});return d.put_static_content=function(t){return d.heatmap?(d.g=d.heatmap.svg.append("g").attr("class","dendogram"),d.svg=e.svg,d.container=e.container):(d.container=t.append("div").style("position","relative"),d.svg=d.container.append("svg"),d.g=d.svg.append("g")),d},d.remove=function(){var t,e,a;d.g.remove(),d.heatmap&&(t=d.heatmap,a="horizontal"==d.orientation()?"Col":"Row",t.showDendogram(a,!1),t["dendogram"+a]=void 0,0<t.transitionDuration()&&!t.transitionOff?(e=d3.transition("remove").duration(t.transitionDuration()),t.svg.selectAll(".label_panel."+a.toLowerCase()).transition(e).attr("transform","translate("+t.paddings().left+", "+t.paddings().top+")"),"Row"==a?t.svg.select(".row").selectAll("text").transition(e).style("text-anchor","end"):t.svg.select(".col").selectAll("text").transition(e).style("text-anchor","start")):(t.svg.selectAll(".label_panel."+a.toLowerCase()).attr("transform","translate("+t.paddings().left+", "+t.paddings().top+")"),"Row"==a?t.svg.select(".row").selectAll("text").style("text-anchor","end"):t.svg.select(".col").selectAll("text").style("text-anchor","start")))},d.update=function(){return d.cluster(),d.draw(),d},d.place=function(t){if("string"==typeof(t=void 0===t?"body":t)){var e=t;if(0==(t=d3.select(e)).size())throw"Error in function 'place': DOM selection for string '"+e+"' did not find a node."}return d.put_static_content(t),void 0===d.heatmap&&d.update(),d},d}function D(t,u){(u=x().add_property("nrows",void 0,v("number_nonneg","nrows")).add_property("ncols",void 0,v("number_nonneg","ncols")).add_property("colLabel",function(t){return t},v("array_fun","colLabel")).add_property("rowLabel",function(t){return t},v("array_fun","rowLabel")).add_property("colIds",void 0,v("array","colIds")).add_property("rowIds",void 0,v("array","rowIds")).add_property("dispColIds",function(){return u.colIds()},v("array","dispColIds")).add_property("dispRowIds",function(){return u.rowIds()},v("array","dispRowIds")).add_property("heatmapRow",function(t){return u.dispRowIds().indexOf(t)},v("array_fun","heatmapRow")).add_property("heatmapCol",function(t){return u.dispColIds().indexOf(t)},v("array_fun","heatmapCol")).add_property("showDendogramRow",!0).add_property("showDendogramCol",!0).add_property("value",void 0,v("matrix_fun","value")).add_property("mode","default").add_property("colour").add_property("palette",t=>d3.interpolateRdYlBu(1-t),function(e){if("string"==typeof e){if(d3[e])return d3[e];throw"Error in 'typeCheck' for 'palette': invalid palette name, must be one of d3 interpolators (e.g. 'interpolateOrRd')."}if(Array.isArray(e))return e=e.map(t=>/^#[0-9a-fA-F]{8,8}$/.test(t)?t.substring(0,7):t),d3.scaleLinear().domain(d3.range(e.length).map(function(t){return t/(e.length-1)})).range(e);if("function"==typeof e)return e;throw"Error in 'typeCheck' for 'palette': invalid type. Palette must be a name of a d3 interpolator, an array of colours or a function."}).add_property("colourDomain",function(){return u.dataRange()},v("array","colourDomain")).add_property("clusterRowMetric",m).add_property("clusterColMetric",m).add_property("on_click",function(){}).add_property("rowTitle","").add_property("showValue",!1).add_property("valueTextColour",(t,e)=>{t=d3.hsl(u.get_colour(u.get_value(t,e)));return t.h=(t.h+180)%360,t.s=Math.sqrt(t.s),t.l=1-t.l,t},function(t){if("function"==typeof t)return t;if("string"==typeof t)return t;throw"Error in 'typeCheck' for 'valueTextColour': invalid type. valueTextColour must be a colour name or a function."}).add_property("showInform",!0).add_property("colTitle","").add_property("on_mouseover").add_property("on_mouseout").add_property("on_labelClickRow").add_property("on_labelClickCol").add_property("clusterRows",!1).add_property("clusterCols",!1).add_property("legendTitle","").add_property("informText",function(t,e){var a=u.get_value(t,e);return"number"==typeof a&&(a=a.toFixed(2)),"Row: <b>"+u.get_rowLabel(t)+"</b>;<br>Col: <b>"+u.get_colLabel(e)+"</b>;<br>value = "+a},v("matrix_fun","value"))).paddings({top:100,left:100,right:10,bottom:40}),u.legend.width(75),["col","row"].forEach(function(a){u.wrapSetter("n"+a+"s",function(t){return function(){return u["get_"+a+"Ids"]=function(){return d3.range(t())},t.apply(u,arguments)}}),u.wrapSetter(a+"Ids",function(e){return function(){u["get_n"+a+"s"]=function(){return e().length};var t=a[0].toUpperCase()+a.slice(1);return e.apply(u,arguments),u["get_disp"+t+"Ids"]=u["get_"+a+"Ids"],u}})}),u.wrapSetter("colour",function(a){return function(){var t=a.apply(u,arguments),e=u.get_colour;return u.get_colour=function(){return 1==arguments.length&&void 0===arguments[0]?"#eee":e.apply(u,arguments)},t}}),u.wrapSetter("showValue",function(a){return function(){var t=a.apply(u,arguments),e=u.get_showValue;return u.get_showValue=function(){return e.apply(u,arguments)&&void 0!==u.cellSize&&10<u.cellSize.height&&10<u.cellSize.width},t}}),["col","row"].forEach(function(t){var a="col"==t?"bottom":"right";u.wrapSetter(t+"Title",function(e){return function(){var t={};return t[a]=d3.max([u.paddings()[a],20]),u.set_paddings(t),e.apply(u,arguments)}})}),u.colour(function(t){return u.colourScale(t)}),u.axes={},u.marked=[],a={Row:u.showDendogramRow(),Col:u.showDendogramCol()},u.showDendogram=function(t,e){return void 0===e?a[t]:(a[t]=e&&u["showDendogram"+t](),u)},u.showDendogram("Row",!1).showDendogram("Col",!1);var a,e=u.put_static_content,i=(u.put_static_content=function(t){e(t),f(u),u.svg.append("g").attr("class","row label_panel"),u.svg.append("g").attr("class","col label_panel"),u.canvas=u.container.append("canvas").style("position","absolute").style("z-index",-5).attr("id","hCanvas"),u.g=u.svg.select(".plotArea").append("g").attr("class","chart_g"),u.text=u.g.append("g").attr("class","text_g"),u.axes.x_label=u.svg.append("text").attr("class","axisLabel").attr("text-anchor","end"),u.axes.y_label=u.svg.append("text").attr("class","axisLabel").attr("text-anchor","end").attr("transform","rotate(-90)"),("svg"==i()?u.g:u.canvas).classed("active",!0),u.svg.select(".clickPanel").on("mouseover",function(){u.container.select(".inform").classed("hidden",!1)}).on("mouseout",function(){u.container.select(".inform").classed("hidden",!0)}),u.showPanel()&&(u.panel.add_button("Zoom in","#zoomIn",function(t){var e=-Math.ceil(.1*t.dispRowIds().length),a=-Math.ceil(.1*t.dispColIds().length);t.dispRowIds(o(e,"top")),t.dispRowIds(o(e,"bottom")),t.dispColIds(o(a,"left")),t.dispColIds(o(a,"right")),t.updateStarted=!0,t.updateLabels(),t.updateLabelPosition(),t.updateStarted=!1},"Double click to return to original scales"),u.panel.add_button("Zoom out","#zoomOut",function(t){var e=Math.ceil(.1*t.dispRowIds().length),a=Math.ceil(.1*t.dispColIds().length);t.dispRowIds(o(e,"top")),t.dispRowIds(o(e,"bottom")),t.dispColIds(o(a,"left")),t.dispColIds(o(a,"right")),t.updateStarted=!0,t.updateLabels(),t.updateLabelPosition(),t.updateCellColour(),t.updateLabelText(),t.updateStarted=!1},"Double click to return to original scales"),u.panel.add_button("Cluster rows","#clusterRows",function(t){t.cluster("Row"),t.showDendogram("Row",!0),t.updateLabelPosition()}),u.panel.add_button("Cluster columns","#clusterCols",function(t){t.cluster("Col"),t.showDendogram("Col",!0),t.updateLabelPosition()}),u.panel.add_button("Restore original order","#restoreOrder",function(t){var a=t.rowIds().slice(),r=t.colIds().slice();t.reorder("Row",function(t,e){return a.indexOf(t)-a.indexOf(e)}),t.reorder("Col",function(t,e){return r.indexOf(t)-r.indexOf(e)}),t.dendogramRow&&t.dendogramRow.remove(),t.dendogramCol&&t.dendogramCol.remove(),t.updateStarted=!0,t.updateLabels().updateLabelPosition().updateLabelText().updateCellColour(),t.updateStarted=!1}))},function(){return"default"==u.mode()?2500<u.dispColIds().length*u.dispRowIds().length?"canvas":"svg":u.mode()});function r(t,e){d3.select(e.target).classed("hover",!0)}function n(t,e){d3.select(e.target).classed("hover",!1)}function o(t,e){var a,r,n,o;if("top"!=e&&"bottom"!=e||(-1==(a=u.get_heatmapRow("__order__"))&&(a=u.rowIds()),r=u.dispRowIds()),"left"!=e&&"right"!=e||(-1==(a=u.get_heatmapCol("__order__"))&&(a=u.colIds()),r=u.dispColIds()),0!=t)if(t<0)if(t=-t,"top"==e||"left"==e)for(n=0;0<t&&1<r.length;)-1!=(o=r.indexOf(a[n]))&&(t--,r.splice(o,1)),n++;else for(n=a.length-1;0<t&&1<r.length;)-1!=(o=r.indexOf(a[n]))&&(t--,r.splice(o,1)),n--;else if("top"==e||"left"==e){for(var l=a.length,i=0;i<r.length;i++)l>a.indexOf(r[i])&&(l=a.indexOf(r[i]));for(i=l-1;i>=d3.max([0,l-t]);i--)r.unshift(a[i])}else{l=-1;for(i=0;i<r.length;i++)l<a.indexOf(r[i])&&(l=a.indexOf(r[i]));for(i=l+1;i<d3.min([a.length,l+t+1]);i++)r.push(a[i])}return r}u.findElements=function(e,a){var t=[];if("svg"==i())t=u.g.selectAll(".data_element").filter(function(){var t=[this.x.baseVal.value,this.y.baseVal.value];return t[0]<=a[0]&&t[1]<=a[1]&&t[0]+u.cellSize.width>=e[0]&&t[1]+u.cellSize.height>=e[1]}).data();else for(var r=u.svg.select(".col").selectAll(".label").filter(function(){var t=this.y.baseVal[0].value;return t>=e[0]&&t<=a[0]+u.cellSize.width}).data(),n=u.svg.select(".row").selectAll(".label").filter(function(){var t=this.y.baseVal[0].value;return t>=e[1]&&t<=a[1]+u.cellSize.height}).data(),o=0;o<n.length;o++)for(var l=0;l<r.length;l++)t.push([n[o],r[l]]);return t},u.get_position=function(t){return[u.axes.scale_x(u.get_heatmapCol(t[1]))+u.cellSize.width/2,u.axes.scale_y(u.get_heatmapRow(t[0]))+u.cellSize.height/2]},u.dataRange=function(){for(var t,e,a=0,r=u.get_rowIds(),n=u.get_colIds();(e=d3.extent(n,function(t){return u.get_value(r[a],t)}))[0]<(t=void 0===t?e:t)[0]&&(t[0]=e[0]),e[1]>t[1]&&(t[1]=e[1]),++a<u.get_nrows(););return t},u.reorder=function(a,r){var e,n,o,l,i;return"flip"==r?(u["get_heatmap"+a]("__flip__"),u.updateLabelPosition()):(r.domain=u["disp"+a+"Ids"]().slice(),e=u["get_heatmap"+a]("__order__"),n=(e=-1==e?u[a.toLowerCase()+"Ids"]().slice():e).slice(),o=function(t,e){return-1!=r.domain.indexOf(t)&&-1!=r.domain.indexOf(e)?r(t,e):-1!=n.indexOf(t)&&-1!=n.indexOf(e)?n.indexOf(t)-n.indexOf(e):u[a.toLowerCase()+"Ids"]().indexOf(t)-u[a.toLowerCase()+"Ids"]().indexOf(e)},l=u["disp"+a+"Ids"]().slice().sort(r),i=(e.sort(o),1),u["heatmap"+a](function(t){if("__flip__"!=t)return"__order__"==t?e:"__sort__"!=t?l.indexOf(t):void(l=u["disp"+a+"Ids"]().slice().sort(function(t,e){return i*o(t,e)}));i*=-1,e.reverse()}),u.svg&&u.svg.select("."+("Row"==a?"col":"row")).selectAll(".sorted").classed("selected",!1).classed("sorted",!1)),u};var l=u.updateSize;function s(e,t){t=d3.pointer(t,u.container.node());d3.select(this).attr("fill",function(t){return d3.rgb(u.get_colour(u.get_value(t[0],t[1]))).darker(.5)}).classed("hover",!0),u.svg.select(".col").selectAll(".label").filter(function(t){return t==e[1]}).classed("hover",!0),u.svg.select(".row").selectAll(".label").filter(function(t){return t==e[0]}).classed("hover",!0),u.container.select(".inform").style("left",t[0]+10+"px").style("top",t[1]+10+"px").select(".value").html(function(){return u.get_informText(e[0],e[1])}),u.container.select(".inform").classed("hidden",!1),u.get_on_mouseover(e[0],e[1])}function d(t){d3.select(this).attr("fill",function(t){return u.get_colour(u.get_value(t[0],t[1]))}).classed("hover",!1),u.svg.selectAll(".label").classed("hover",!1),u.container.select(".inform").classed("hidden",!0),u.get_on_mouseout(t[0],t[1])}function c(t,e){var a=d3.select(e.target.parentNode).classed("row")?"row":"col";d3.select(e.target).classed("sorted")?"col"==a?u.reorder("Row","flip"):u.reorder("Col","flip"):("col"==a?u.get_on_labelClickCol(t):u.get_on_labelClickRow(t),u.updateLabelPosition()),d3.select(e.target.parentNode).selectAll(".label").classed("selected",!1),d3.select(e.target).classed("selected",!0)}u.updateSize=function(){l();var t,e=d3.max([d3.min([u.paddings().bottom-4,15]),3]),a=d3.max([d3.min([u.paddings().right-4,15]),3]),r=d3.min([u.height(),u.plotHeight()+e+u.paddings().top]),n=d3.min([u.width(),u.plotWidth()+a+u.paddings().left]);return(0<u.transitionDuration()&&!u.transitionOff?(t=d3.transition("size").duration(u.transitionDuration()),u.showDendogram("Row")||u.svg.selectAll(".label_panel.row").transition(t).attr("transform","translate("+u.paddings().left+", "+u.paddings().top+")"),u.showDendogram("Col")||u.svg.selectAll(".label_panel.col").transition(t).attr("transform","translate("+u.paddings().left+", "+u.paddings().top+")"),u.axes.x_label.transition(t).attr("font-size",e).attr("x",u.plotWidth()+u.paddings().left).attr("y",r),u.axes.y_label.transition(t)):(u.showDendogram("Row")||u.svg.selectAll(".label_panel.row").attr("transform","translate("+u.paddings().left+", "+u.paddings().top+")"),u.showDendogram("Col")||u.svg.selectAll(".label_panel.col").attr("transform","translate("+u.paddings().left+", "+u.paddings().top+")"),u.axes.x_label.attr("font-size",e).attr("x",u.get_plotWidth()+u.paddings().left).attr("y",r),u.axes.y_label)).attr("font-size",a).attr("x",-u.paddings().top).attr("y",n),u.canvas.style("left",u.paddings().left+"px").style("top",u.paddings().top+"px").attr("width",u.plotWidth()).attr("height",u.plotHeight()),u.updateLabelPosition(),u},u.updateLabelPosition=function(){var t=u.dispColIds().length,e=u.dispRowIds().length;return u.get_heatmapRow("__sort__"),u.get_heatmapCol("__sort__"),u.cellSize={width:u.plotWidth()/t,height:u.plotHeight()/e},u.axes.scale_x=d3.scaleLinear().domain([0,t-1]).range([0,u.plotWidth()-u.cellSize.width]),u.axes.scale_y=d3.scaleLinear().domain([0,e-1]).range([0,u.plotHeight()-u.cellSize.height]),(0<u.transitionDuration()&&!u.transitionOff?(t=d3.transition("labelPosition").duration(u.transitionDuration()),u.svg.select(".col").selectAll(".label").transition(t).attr("font-size",d3.min([u.cellSize.width-2,14])).attr("y",function(t){return u.axes.scale_x(u.get_heatmapCol(t)+1)}).attr("dy",-2),u.svg.select(".row").selectAll(".label").transition(t).attr("font-size",d3.min([u.cellSize.height-2,14])).attr("y",function(t){return u.axes.scale_y(u.get_heatmapRow(t)+1)})):(u.svg.select(".col").selectAll(".label").attr("font-size",d3.min([u.cellSize.width-2,14])).attr("y",function(t){return u.axes.scale_x(u.get_heatmapCol(t)+1)}).attr("dy",-2),u.svg.select(".row").selectAll(".label").attr("font-size",d3.min([u.cellSize.height-2,14])).attr("y",function(t){return u.axes.scale_y(u.get_heatmapRow(t)+1)}))).attr("dy",-2),u.updateCellPosition(),u.showDendogram("Col")&&u.drawDendogram("Col"),u.showDendogram("Row")&&u.drawDendogram("Row"),u},u.updateLabels=function(){var t=u.dispColIds(),e=u.dispRowIds(),t=(u.cellSize={width:u.plotWidth()/t.length,height:u.plotHeight()/e.length},u.svg.select(".col").selectAll(".label").data(t,function(t){return t})),e=(t.exit().remove(),u.svg.select(".row").selectAll(".label").data(e,function(t){return t}));return e.exit().remove(),t.enter().append("text").attr("class","label plainText").attr("transform","rotate(-90)").style("text-anchor","start").attr("dx",2).merge(t).attr("id",function(t){return t.toString().replace(/[ .]/g,"_")}).on("mouseover",(t,e)=>r(0,t)).on("mouseout",(t,e)=>n(0,t)).on("click",(t,e)=>c(e,t)),e.enter().append("text").attr("class","label plainText").style("text-anchor","end").attr("dx",-2).merge(e).attr("id",function(t){return t.toString().replace(/[ .]/g,"_")}).on("mouseover",(t,e)=>r(0,t)).on("mouseout",(t,e)=>n(0,t)).on("click",(t,e)=>c(e,t)),u.updateCells(),u},u.updateLabelText=function(){var t;return 0<u.transitionDuration()&&!u.transitionOff?(t=d3.transition("labelText").duration(u.transitionDuration()),u.svg.select(".col").selectAll(".label").transition(t).text(function(t){return u.get_colLabel(t)}),u.svg.select(".row").selectAll(".label").transition(t).text(function(t){return u.get_rowLabel(t)})):(u.svg.select(".col").selectAll(".label").text(function(t){return u.get_colLabel(t)}),u.svg.select(".row").selectAll(".label").text(function(t){return u.get_rowLabel(t)})),u},u.zoom=function(t,e){t=u.findElements(t,e);if(!(t.length<2)){for(var a=[],r=[],n=(t.map(function(t){a.push(t[0]),r.push(t[1])}),[]),o=[],l=0;l<a.length;l++)-1==n.indexOf(a[l])&&n.push(a[l]);for(l=0;l<r.length;l++)-1==o.indexOf(r[l])&&o.push(r[l]);return 0<n.length&&u.dispRowIds(n),u.dispColIds(o),u.updateStarted=!0,u.updateLabels(),u.updateLabelPosition(),u.updateStarted=!1,u}},u.resetDomain=function(){return u.dispColIds(u.colIds()),u.dispRowIds(u.rowIds()),u.updateStarted=!0,u.updateLabels().updateLabelPosition().updateCellColour().updateLabelText(),u.updateStarted=!1,u},u.resetColourScale=function(){var t=u.colourDomain();2==t.length&&"number"==typeof(t[0]+t[1])?u.colourScale=d3.scaleSequential(u.get_palette).domain(t):(u.colourScale=d3.scaleOrdinal().domain(t),"function"==typeof u.get_palette.range?u.colourScale.range(u.get_palette.range()):u.get_palette().splice?u.colourScale.range(u.get_palette()):u.colourScale.range(d3.schemeSet1)),u.showLegend()&&u.legend&&u.legend.set_title({heatmap:u.legendTitle()}).add_block(u.colourScale,"colour","heatmap")},u.on_labelClickCol(function(a){u.reorder("Row",function(t,e){return u.get_value(e,a)-u.get_value(t,a)}),u.dendogramRow&&u.dendogramRow.remove()}),u.on_labelClickRow(function(a){u.reorder("Col",function(t,e){return u.get_value(a,e)-u.get_value(a,t)}),u.dendogramCol&&u.dendogramCol.remove()});u.updateCellColour=function(){return u.checkMode()&&("svg"==i()?(0<u.transitionDuration()&&!u.transitionOff?u.g.selectAll(".data_element").transition("cellColour").duration(u.transitionDuration()).attr("fill",function(t){return u.get_colour(u.get_value(t[0],t[1]))}):u.g.selectAll(".data_element").attr("fill",function(t){return u.get_colour(u.get_value(t[0],t[1]))}),u.svg.selectAll(".sorted").classed("selected",!1).classed("sorted",!1),u.get_showValue()&&u.updateTextValues()):u.updateStarted||u.updateCanvas(),u.svg.selectAll(".sorted").filter(function(t){var e,a=this,r=d3.select(a).datum(),n=!0,o=1;if(d3.select(a.parentNode).classed("row")){for(e=u.dispColIds();n&&o<e.length;)u.get_value(r,e[o])>u.get_value(r,e[o-1])&&(n=!1),o++;if(!n)for(o=1,n=!0;n&&o<e.length;)u.get_value(r,e[o])<u.get_value(r,e[o-1])&&(n=!1),o++}else{for(e=u.dispRowIds();n&&o<e.length;)u.get_value(e[o],r)>u.get_value(e[o-1],r)&&(n=!1),o++;if(!n)for(o=1,n=!0;n&&o<e.length;)u.get_value(e[o],r)<u.get_value(e[o-1],r)&&(n=!1),o++}return!n}).classed("sorted",!1).classed("selected",!1)),u},u.updateCells=function(){if(u.checkMode()){var t=u.get_marked().length;if("svg"==i()){var e=u.g.selectAll(".data_row").data(u.get_dispRowIds(),function(t){return t}),e=(e.exit().remove(),e.enter().append("g").attr("class","data_row"),u.g.selectAll(".data_row").selectAll(".data_element").data(function(e){return u.get_dispColIds().map(function(t){return[e,t]})},function(t){return t}));e.exit().remove(),e.enter().append("rect").attr("class","data_element").merge(e).attr("id",function(t){return"p"+(t[0]+"_-sep-_"+t[1]).replace(/[ .]/g,"_")}).attr("rowId",function(t){return t[0]}).attr("colId",function(t){return t[1]}).on("mouseover",(t,e)=>s(e,t)).on("mouseout",d).on("click",function(t,e){u.get_on_click.apply(this,[e[0],e[1],t])}),u.updateTexts()}else{for(var a=u.dispRowIds(),r=u.dispColIds(),n=0;n<u.marked.length;)-1==a.indexOf(u.marked[n][0])||-1==r.indexOf(u.marked[n][1])?u.marked.splice(n,1):n++;u.updateStarted||u.updateCanvas()}e=u.get_marked().length;e<t&&u.on_marked(),0==e&&u.g.selectAll(".data_element").attr("opacity",1)}return u},u.updateCellPosition=function(){return u.checkMode()&&("svg"==i()?(0<u.transitionDuration()&&!u.transitionOff?u.g.selectAll(".data_element").transition("cellPosition").duration(u.transitionDuration()).attr("x",function(t){return u.axes.scale_x(u.get_heatmapCol(t[1]))}).attr("width",u.cellSize.width).attr("height",u.cellSize.height).attr("y",function(t){return u.axes.scale_y(u.get_heatmapRow(t[0]))}):u.g.selectAll(".data_element").attr("x",function(t){return u.axes.scale_x(u.get_heatmapCol(t[1]))}).attr("width",u.cellSize.width).attr("height",u.cellSize.height).attr("y",function(t){return u.axes.scale_y(u.get_heatmapRow(t[0]))}),u.get_showValue()&&u.updateTextPosition()):u.updateCanvas()),u},u.cluster=function(a,t){if("Row"!=a&&"Col"!=a)throw"Error in 'cluster': type "+a+" cannot be recognised. Please, use either 'Row' or 'Col'";u.showDendogram(a,!0),void 0===u["dendogram"+a]&&(u["dendogram"+a]=z(u),"Row"==a?u["dendogram"+a].orientation("vertical"):u["dendogram"+a].orientation("horizontal")),u["dendogram"+a].elementIds(function(){return u["disp"+a+"Ids"]()}),void 0===t&&(t="Row"==a?u.dispColIds():u.dispRowIds()),"Row"==a?u["dendogram"+a].data(g(function(e){return t.map(function(t){return u.get_value(e,t)})})):u["dendogram"+a].data(g(function(e){return t.map(function(t){return u.get_value(t,e)})})),u["dendogram"+a].distance(function(t,e){return u["get_cluster"+a+"Metric"](t,e)}).cluster();var r=u["dendogram"+a].clusters.val_inds;return u.reorder(a,function(t,e){return r.indexOf(t)-r.indexOf(e)}),u},u.drawDendogram=function(t){return void 0!==u["dendogram"+t]&&(void 0===u["dendogram"+t].g?u["dendogram"+t].place():u["dendogram"+t].g.selectAll("line").remove(),u["dendogram"+t].draw()),u},u.updateTexts=function(){var t=u.g.selectAll(".text_row").data(u.get_dispRowIds(),function(t){return t}),t=(t.exit().remove(),t.enter().append("g").attr("class","text_row"),u.g.selectAll(".text_row").selectAll(".tval").data(function(e){return u.get_dispColIds().map(function(t){return[e,t]})},function(t){return t}));return u.showValue()?(t.exit().remove(),t.enter().append("text").attr("class","tval").attr("text-anchor","middle").on("click",function(t,e){var a=u.svg.selectAll("#p"+(e[0]+"_-sep-_"+e[1]).replace(/[ .]/g,"_")).node();u.get_on_click.apply(a,[e[0],e[1]])}).on("mouseover",function(t,e){var a=u.svg.selectAll("#p"+(e[0]+"_-sep-_"+e[1]).replace(/[ .]/g,"_")).node();s.apply(a,[e,t])}).on("mouseout",function(t,e){var a=u.svg.selectAll("#p"+(e[0]+"_-sep-_"+e[1]).replace(/[ .]/g,"_")).node();d.apply(a,[e,t])}),u.updateTextValues()):t.remove(),u},u.updateTextPosition=function(){return 0<u.transitionDuration()&&!u.transitionOff?u.g.selectAll(".tval").transition("textPosition").duration(u.transitionDuration()).attr("x",function(t){return u.axes.scale_x(u.get_heatmapCol(t[1]))+u.cellSize.width/2}).attr("font-size",.4*u.cellSize.height).attr("y",function(t){return u.axes.scale_y(u.get_heatmapRow(t[0]))+.75*u.cellSize.height}):u.g.selectAll(".tval").attr("x",function(t){return u.axes.scale_x(u.get_heatmapCol(t[1]))+u.cellSize.width/2}).attr("font-size",.4*u.cellSize.height).attr("y",function(t){return u.axes.scale_y(u.get_heatmapRow(t[0]))+.75*u.cellSize.height}),u},u.updateTextValues=function(){return 0<u.transitionDuration()&&!u.transitionOff?u.g.selectAll(".tval").transition("textValues").duration(u.transitionDuration()).attr("fill",t=>u.get_valueTextColour(t[0],t[1])).text(function(t){t=u.get_value(t[0],t[1]);return void 0===t?"":t.toFixed?t.toFixed(1):t}):u.g.selectAll(".tval").attr("fill",t=>u.get_valueTextColour(t[0],t[1])).text(function(t){t=u.get_value(t[0],t[1]);return void 0===t?"":t.toFixed?t.toFixed(1):t}),u},u.checkMode=function(){if("svg"==i()&&u.canvas.classed("active"))return u.canvas.classed("active",!1),u.g.classed("active",!0),u.canvas.node().getContext("2d").clearRect(0,0,u.plotWidth(),u.plotHeight()),!(!u.updateStarted&&(u.updateStarted=!0,u.updateLabels().updateLabelText().updateCellColour(),u.updateStarted=!1,u.mark(u.marked,!0),u.marked=[]));if("canvas"==i()&&u.g.classed("active"))for(u.canvas.classed("active",!0),u.marked=u.g.selectAll(".marked").data(),u.g.classed("active",!1);u.g.node().firstChild;)u.g.node().removeChild(u.g.node().firstChild);return!0},u.updateCanvas=function(){var t,e,n=u.canvas.node().getContext("2d"),o=(n.clearRect(0,0,u.plotWidth(),u.plotHeight()),u.dispRowIds()),l=u.dispColIds(),a=l.length,r=o.length,i=document.createElement("canvas"),s=(i.width=a,i.height=r,new ImageData(a,r));if(0==u.marked.length)for(var d=0;d<r;d++)for(var c=0;c<a;c++)t=d3.rgb(u.get_colour(u.get_value(o[d],l[c]))),e=u.get_heatmapRow(o[d])*a*4+4*u.get_heatmapCol(l[c]),s.data[e]=t.r,s.data[e+1]=t.g,s.data[e+2]=t.b,s.data[e+3]=255;else{for(d=0;d<r;d++)for(c=0;c<a;c++)t=d3.rgb(u.get_colour(u.get_value(o[d],l[c]))),e=u.get_heatmapRow(o[d])*a*4+4*u.get_heatmapCol(l[c]),s.data[e]=t.r/4,s.data[e+1]=t.g/4,s.data[e+2]=t.b/4,s.data[e+3]=55;for(d=0;d<u.marked.length;d++)e=u.get_heatmapRow(u.marked[d][0])*a*4+4*u.get_heatmapCol(u.marked[d][1]),s.data[e]*=4,s.data[e+1]*=4,s.data[e+2]*=4,s.data[e+3]=255}if(i.getContext("2d").putImageData(s,0,0),n.imageSmoothingEnabled=!1,n.drawImage(i,0,0,a,r,0,0,u.plotWidth(),u.plotHeight()),u.showValue()){n.font=.4*u.cellSize.height+"px arial",n.textAlign="center";for(d=0;d<o.length;d++)for(c=0;c<l.length;c++){let t=u.axes.scale_x(u.get_heatmapCol(l[c]))+u.cellSize.width/2,e=u.axes.scale_y(u.get_heatmapRow(o[d]))+.75*u.cellSize.height,a=u.get_value(o[d],l[c]),r=d3.hsl(u.get_colour(a));void 0!==a&&(r.h=(r.h+180)%360,r.s=Math.floor(100*Math.sqrt(r.s)),r.l=Math.floor(100*(1-r.l)),n.fillStyle="hsl("+r.h+","+r.s+"%,"+r.l+"%)",a=a.toFixed?a.toFixed(1):a,n.fillText(a,t,e,u.cellSize.width))}}},u.get_elements=function(t){return t=(t=2==t.length&&t[0].substr?[t]:t).map(function(t){return"p"+t.join("_-sep-_")}),"svg"==i()?0<t.length?u.svg.selectAll("#"+_(t.join(",#").replace(/[ .]/g,"_"))):u.svg.selectAll("______"):t},u.get_marked=function(){var t;return"svg"==i()?(t=[],u.svg.selectAll(".marked").each(function(){t.push(d3.select(this).datum())}),t):u.marked};var p=u.mark;return u.mark=function(t,e){if("svg"==i())p(t,e);else if("__clear__"==t)u.marked=[];else{t.length&&t[0].substr&&(t=t.map(function(t){return t.substr(1).split("_-sep-_")}));for(var a=u.marked.map(function(t){return t.join("_")}),r=0;r<t.length;r++)-1==a.indexOf(t[r].join("_"))&&u.marked.push(t[r])}return"canvas"==i()&&u.updateCanvas(),e||u.on_marked(),u},u.panMove=function(t){var t=[t[0]-u.pan("down")[0],t[1]-u.pan("down")[1]],e=Math.floor(Math.abs(t[1]/u.cellSize.height)),a=Math.floor(Math.abs(t[0]/u.cellSize.width));u.pan("down")[0]+=Math.sign(t[0])*a*u.cellSize.width,u.pan("down")[1]+=Math.sign(t[1])*e*u.cellSize.height,u.dispColIds(o(-Math.sign(t[0])*a,"right")),u.dispColIds(o(Math.sign(t[0])*a,"left")),u.dispRowIds(o(Math.sign(t[1])*e,"top")),u.dispRowIds(o(-Math.sign(t[1])*e,"bottom")),0<Math.abs(e)+Math.abs(a)&&(u.updateStarted=!0,u.updateLabels(),u.updateLabelPosition(),u.updateCellColour(),u.updateLabelText(),u.updateStarted=!1)},u.update=function(){return u.updateTitle(),u.resetColourScale(),u.dispColIds(function(){return u.colIds()}),u.dispRowIds(function(){return u.rowIds()}),u.axes.x_label.text(u.get_colTitle()),u.axes.y_label.text(u.get_rowTitle()),u.updateStarted=!0,u.updateLabels(),u.clusterRows()&&u.cluster("Row"),u.clusterCols()&&u.cluster("Col"),u.updateSize().updateLabelText().updateCellColour(),u.updateStarted=!1,u},u}function R(t,e,a){return 1/(1+Math.exp(-a*(t-e)))}function T(){var e=x().add_property("content",""),a=(e.width(0).height(0).paddings({top:5,left:5,bottom:5,right:5}).showPanel(!1),e.put_static_content);return e.put_static_content=function(t){a(t),e.svg.remove(),e.container.style("overflow","auto"),e.container.select("table").remove(),e.container.select("div").remove()},e.updateSize=function(){return e.container.style("width",0!=e.width()?e.width():void 0).style("height",0!=e.height()?e.height():void 0).style("padding-top",e.paddings().top).style("padding-left",e.paddings().left).style("padding-right",e.paddings().right).style("padding-bottom",e.paddings().bottom),e},e.inherited_update=e.update,e.update=function(){return e.inherited_update(),e.container.node().innerHTML=e.content(),e},e}t.add_click_listener=f,t.axesChart=n,t.barchart=M,t.base=h,t.beeswarm=L,t.cache=g,t.call_pacer=e,t.chartBase=x,t.check=v,t.colourSlider=function(){function r(){var t=d3.min(g.get_straightColourScale.domain()),e=d3.max(g.get_straightColourScale.domain());g.get_midpoint()<t&&g.midpoint(t),g.get_midpoint()>e&&g.midpoint(e),g.midpoint()-t<g.slopeWidth()/2&&g.slopeWidth(2*(g.midpoint()-t)),e-g.midpoint()<g.slopeWidth()/2&&g.slopeWidth(2*(e-g.midpoint()))}var g=x().add_property("straightColourScale").add_property("midpoint",void 0).add_property("slopeWidth",void 0).add_property("linkedChart",void 0,function(t){if("string"==typeof t){var e=t.split(".");t=window[e[0]];for(var a=1;a<e.length;a++)t=t[e[a]]}return t}).add_property("on_drag",function(){}).add_property("on_change",function(){}).paddings({top:20,right:10,bottom:5,left:10}).height(80).transitionDuration(0),n=(g.showPanel(!1),g.straightColourScale(d3.scaleLinear().range(["white","darkblue"])),g.setStraightColourScale=function(){g.linkedChart()&&g.linkedChart().colourScale&&(g.straightColourScale(g.linkedChart().colourScale),g.linkedChart().updateElementStyle&&g.on_drag(g.linkedChart().updateElementStyle),g.linkedChart().updateCellColour)&&g.on_drag(g.linkedChart().updateCellColour)},g.put_static_content),f=(g.put_static_content=function(t){n(t);var t=g.svg.append("g").attr("class","sigmoidColorSlider").attr("transform","translate("+g.paddings().left+", "+g.paddings().top+")"),e=(g.axis=t.append("g").attr("class","axis"),t.append("defs")),a=(g.gradient=e.append("linearGradient").attr("id","scaleGradient"+Math.random().toString(36).substring(2,6)).attr("x1","0%").attr("y1","0%").attr("x2","100%").attr("y2","0%"),g.gradient.selectAll("stop").data(d3.range(100)).enter().append("stop").attr("offset",function(t){return t+"%"}),g.gradient.attr("id"));g.colorBar=t.append("rect").attr("x","0").attr("y","5").attr("height",20).attr("fill","url(#"+a+")").style("stroke","black").style("stroke-width","1"),e.append("path").attr("id","mainMarker").attr("d","M 0 0 L 8 5 L 8 25 L -8 25 L -8 5 Z").style("fill","gray").style("stroke","black"),e.append("path").attr("id","rightMarker").attr("d","M 0 0 L 5 5 L 5 15 L 0 15 Z").style("fill","lightgray").style("stroke","black"),e.append("path").attr("id","leftMarker").attr("d","M 0 0 L -5 5 L -5 15 L 0 15 Z").style("fill","lightgray").style("stroke","black"),g.mainMarker=t.append("use").attr("xlink:href","#mainMarker").attr("y",28).call(d3.drag().on("drag",function(t){g.midpoint(g.pos_scale.invert(g.pos_scale(g.get_midpoint())+t.dx)),r(),g.get_on_drag(),g.update()}).on("end",function(){g.get_on_change()})),g.rightMarker=t.append("use").attr("xlink:href","#rightMarker").attr("y",30).call(d3.drag().on("drag",function(t){g.slopeWidth(g.pos_scale.invert(g.pos_scale(g.slopeWidth())+2*t.dx)),r(),g.update(),g.get_on_drag()}).on("end",function(){g.get_on_change()})),g.leftMarker=t.append("use").attr("xlink:href","#leftMarker").attr("y",30).call(d3.drag().on("drag",function(t){g.slopeWidth(g.pos_scale.invert(g.pos_scale(g.slopeWidth())-2*t.dx)),r(),g.update(),g.get_on_drag()}).on("end",function(){g.get_on_change()}))},g.update);return g.update=function(){f(),g.setStraightColourScale(),null==g.get_straightColourScale.domain&&(g.get_straightColourScale.domain=function(){return[0,1]});for(var t=g.get_straightColourScale.domain(),e=[],a=[],r=!0,n=0;n<t.length;n++)e.push(100*n/(t.length-1)),a.push(n*g.plotWidth()/(t.length-1)),r="number"==typeof t[n]&&r;if(!r)return g.colourScale=g.get_straightColourScale,g;var o,l,i,s,d,c,u,p=d3.scaleLinear().domain(e).range(t);null==g.get_midpoint()&&g.midpoint(p(50)),null==g.get_slopeWidth()&&g.slopeWidth(Math.abs(p(70)-p(0))),g.pos_scale=d3.scaleLinear().range(a).domain(t),d3.axisTop().scale(g.pos_scale)(g.axis),g.colorBar.attr("width",g.get_plotWidth()),g.the_sigmoid=(o=g.get_midpoint(),l=1.38/g.slopeWidth(),i=d3.min(g.get_straightColourScale.domain()),s=d3.max(g.get_straightColourScale.domain()),d=R(i,o,l),c=R(s,o,l),u=Math.min(d,c),function(t){return(R(t,o,l)-u)/Math.abs(c-d)}),g.gradient.selectAll("stop").data(d3.range(100)).style("stop-color",function(t){return g.get_straightColourScale(p(100*g.the_sigmoid(p(t))))}),g.colourScale=function(t){return g.get_straightColourScale(p(100*g.the_sigmoid(t)))},g.linkedChart()&&g.linkedChart().colour&&g.linkedChart().colour(function(t){return g.linkedChart().colourValue&&(t=g.linkedChart().get_colourValue(t)),g.colourScale(t)}),g.mainMarker.attr("x",g.pos_scale(g.get_midpoint())),g.rightMarker.attr("x",g.pos_scale(g.get_midpoint()+g.slopeWidth()/2)),g.leftMarker.attr("x",g.pos_scale(g.get_midpoint()-g.slopeWidth()/2))},g},t.dendogram=z,t.escapeRegExp=_,t.getEuclideanDistance=m,t.get_symbolSize=y,t.heatmap=D,t.html=T,t.image=function(){var e=x().add_property("src",void 0,function(t){if(void 0!==t&&"string"!=typeof t)throw"Error in 'typeCheck' for property 'src': must be a string or undefined.";return t}).showPanel(!1).showLegend(!1).paddings({top:35,right:10,bottom:10,left:10}),a=e.put_static_content,t=(e.put_static_content=function(t){a(t),e.svg.select(".plotArea").append("image")},e.updateElements=function(){return e.svg.select("image").attr("href",e.src()),e},e.updateSize),r=(e.updateSize=function(){return t(),e.svg.select("image").attr("width",e.plotWidth()).attr("height",e.plotHeight()),e},e.update);return e.update=function(){return r(),e.updateElements(),e},e},t.input=function(){var a=T().add_property("type","text",function(t){if(-1==["text","radio","checkbox","button","range"].indexOf(t))throw"Error in 'typeCheck' for property 'type': the supported types are 'text', 'radio', 'checkbox', 'button', 'range'.";return t}).add_property("label",t=>t,v("array_fun","label")).add_property("nelements",1,v("number_nonneg","nelements")).add_property("elementIds",[0],v("array","elementIds")).add_property("value",function(){},v("array_fun","value")).add_property("min",0,v("array_fun","min")).add_property("max",100,v("array_fun","max")).add_property("step",1,v("array_fun","step")).add_property("fontSize",17,v("number_nonneg","fontSize")).add_property("ncols",1,v("number_nonneg","ncols")).add_property("nrows",function(){return a.nelements()},v("number_nonneg","nrows")).add_property("on_change",function(){}),e=(a.wrapSetter("nelements",function(t){return function(){return a.get_elementIds=function(){return d3.range(t())},t.apply(a,arguments)}}),a.wrapSetter("elementIds",function(t){return function(){return a.get_nelements=function(){return t().length},t.apply(a,arguments)}}),a.wrapSetter("nrows",function(t){return function(){return a.get_ncols=function(){return Math.ceil(a.nelements()/t())},t.apply(a,arguments)}}),a.wrapSetter("ncols",function(t){return function(){return a.get_nrows=function(){return Math.ceil(a.nelements()/t())},t.apply(a,arguments)}}),a.value(t=>{switch(a.type()){case"text":return"";case"button":return t;case"range":case"radio":return;case"checkbox":return!1}}),a.name="n"+Math.random().toString(36).substring(5),a.width(200),a.put_static_content);return a.put_static_content=function(t){return e(t),a.container.style("display","grid").style("grid-template-columns","repeat(auto-fit, fit-content(500px) 1fr fit-content(20px))").style("column-gap","9px").style("align-items","center").append("p").style("grid-row",1).style("grid-column","1/"+(3*a.ncols()+1)).style("text-align","center").style("font-weight","bold").attr("id","title"),a},a.updateTitle=function(){return a.container.select("#title").text(a.title()),a},a.updateElements=function(){var t=a.container.selectAll("input").data(a.elementIds()),e=a.container.selectAll("label").data(a.elementIds());return t.enter().append("input").attr("type",a.type()).attr("name",a.name).style("grid-row",(t,e)=>e%a.nrows()+2).style("grid-column",(t,e)=>3*Math.floor(e/a.nrows())+("text"==a.type()||"range"==a.type()?2:1)).attr("id",t=>a.name+"_in_"+t).property("value",t=>"radio"==a.type()?t:void 0).style("width","text"==a.type()||"range"==a.type()?"100%":void 0).on("button"==a.type()?"click":"change",function(){var t,e;a.get_on_change((t=this,"button"==a.type()||"radio"==a.type()?t.value:"checkbox"==a.type()?d3.select(t.parentNode).selectAll("input").nodes().map(t=>t.checked):(e={},"range"!=a.type()&&"text"!=a.type()||d3.select(t.parentNode).selectAll("input").nodes().forEach(function(t){e[t.id.substring(a.name.length+1)]=+t.value?+t.value:t.value}),e)))}),t.exit().remove(),"button"!=a.type()?(e.exit().remove(),e.enter().append("label").attr("for",t=>a.name+"_in_"+t).style("grid-row",(t,e)=>e%a.nrows()+2).style("grid-column",(t,e)=>3*Math.floor(e/a.nrows())+("text"==a.type()||"range"==a.type()?1:2)).merge(e).text(t=>a.get_label(t)).style("font-size",a.fontSize())):a.container.selectAll("input").style("font-size",a.fontSize()).property("value",t=>a.get_label(t)),"range"==a.type()?((t=a.container.selectAll(".currentValue").data(a.elementIds())).enter().append("p").attr("class","currentValue").attr("id",t=>a.name+"_in_"+t).style("grid-row",(t,e)=>e%a.nrows()+2).style("grid-column",(t,e)=>3*Math.floor(e/a.nrows())+3).style("margin-top",0).style("margin-bottom",0),t.exit().remove(),a.container.selectAll("input").on("input",function(t,e){a.container.select(".currentValue#"+this.id).text(this.value)})):a.container.selectAll(".currentValue").remove(),a},a.updateState=function(){return"radio"==a.type()&&a.container.selectAll("input").filter(function(){return this.id==a.name+"_in_"+a.value()}).attr("checked",!0),"checkbox"==a.type()&&a.container.selectAll("input").property("checked",t=>!!a.get_value(t)),"text"==a.type()&&a.container.selectAll("input").property("value",t=>a.get_value(t)),"range"==a.type()&&(a.container.selectAll("input").attr("max",t=>a.get_max(t)).attr("min",t=>a.get_min(t)).attr("step",t=>a.get_step(t)).nodes().forEach((t,e)=>{t.value=a.get_value(a.elementIds()[e])}),a.container.selectAll(".currentValue").text(t=>a.get_value(t))),a},a.update=function(){return a.inherited_update(),a.updateElements(),a.updateState(),a},a},t.isNaN=a,t.layerBase=s,t.layerChart=r,t.parametricCurve=A,t.pearsonCorr=function(t,e){for(var a=0,r=0,n=0;n<t.length;n++)a+=t[n],r+=e[n];for(var o=a/t.length,l=r/e.length,i=0,s=0,d=0,n=0;n<t.length;n++)i+=(t[n]-o)*(e[n]-l),s+=(t[n]-o)*(t[n]-o),d+=(e[n]-l)*(e[n]-l);return i/Math.sqrt(s*d)},t.pointLine=o,t.pointRibbon=function(t,e){var r=o(t,e).activeLayer();return r.add_property("ymax",void 0,v("matrix_fun","ymax")).add_property("ymin",void 0,v("matrix_fun","ymin")),r.type="pointRibbon",r.chart.syncProperties(r),r.opacity(.33).lineWidth(0),r.get_data=function(t){for(var e=[],a=0;a<r.nsteps();a++)e.push({x:r.get_x(a,t),y:r.get_ymin(a,t)});for(a=r.nsteps()-1;0<=a;a--)e.push({x:r.get_x(a,t),y:r.get_ymax(a,t)});return e},r.dresser(function(t){t.attr("fill",function(t){return r.get_colour(t)}).attr("stroke-width",function(t){return r.get_lineWidth(t)}).attr("stroke-dasharray",function(t){return r.get_dasharray(t)}).attr("opacity",function(t){return r.get_opacity(t)})}),r.layerDomainX(function(){var a=[];return r.elementIds().map(function(e){return d3.range(r.nsteps()).map(function(t){0==a.length?a=[r.get_x(t,e),r.get_x(t,e)]:(a[0]=d3.min([r.get_x(t,e),a[0]]),a[1]=d3.max([r.get_x(t,e),a[1]]))})}),a}),r.layerDomainY(function(){var a=[];return r.elementIds().map(function(e){return d3.range(r.nsteps()).map(function(t){0==a.length?a=[r.get_y(t,e),r.get_y(t,e)]:(a[0]=d3.min([a[0],r.get_ymax(t,e),r.get_ymin(t,e)]),a[1]=d3.max([a[1],r.get_ymax(t,e),r.get_ymin(t,e)]))})}),a}),r.chart},t.random=function(t,e){return t=t||1,e=e||0,Math.seed=(9301*Math.seed+49297)%233280,e+Math.seed/233280*(t-e)},t.scatter=C,t.separateBy=function t(e,a,r){if("object"!=typeof e)throw"Error in function 'separateBy': first argument is not an object";if(r=void 0===e.length?"obj":"arr",void 0===(a="number"!=typeof a&&"string"!=typeof a?a:[a]).length)throw"Error in function 'separateBy': "+a.toString()+" is not a property name";if(0==a.length)return e;for(var n,o,l={},i=Object.keys(e),s=!1,d=0;!s&&d<i.length;)"undefined"!==e[i[d]][a[0]]&&(s=!0),d++;if(!s)return a.shift(),t(e,a);for(d=0;d<i.length;d++)void 0!==(n=e[i[d]][a[0]])&&(o={},Object.assign(o,e[i[d]]),delete o[a[0]],void 0===l[n]&&(l[n]="obj"==r?{}:[]),"obj"==r&&(l[n][i[d]]={}),"obj"==r?l[n][i[d]]=o:l[n].push(o));if("arr"==r){for(var c=!0,d=0,u=Object.keys(l);c&&d<u.length;)c=1==l[u[d]].length,d++;if(c)for(var p,d=0;d<u.length;d++)p={},Object.assign(p,l[u[d]][0]),l[u[d]]={},Object.assign(l[u[d]],p)}a.shift();for(d=0;d<u.length;d++)l[u[d]]=t(l[u[d]],a.slice());return l},t.sequenceViewer=function(){const s=D().add_property("seq",void 0,v("array_fun","seq")).add_property("reverseComplement",!1).add_property("startPos",0,v("array_fun","startPos")).add_property("highlightMatches",!0).add_property("reversed",!1,v("array_fun","reversed")).add_property("matchComplementary",t=>t);s.value(function(t,e){var a;return s.get_reversed(t)?(a=s.get_seq(t))[a.length+s.get_startPos(t)-1-e]:s.get_seq(t)[e-s.get_startPos(t)]}).ncols(function(){var e=0,a=s.rowIds();for(let t=0;t<a.length;t++)e=d3.max([e,s.get_startPos(a[t])+s.get_seq(a[t]).length]);return e}).showValue(!0).plotHeight(()=>30*s.nrows()).informText(function(t,e){var a=s.get_value(t,e);return"Sequence: <b>"+s.get_rowLabel(t)+"</b>;<br>Position: <b>"+(e-s.get_startPos(t)+1)+"</b>;<br>nucleotide = "+a}).set_paddings({top:60});var t=s.updateCellColour,e=(s.updateCellColour=function(){return t(),s.highlightMatches()&&(s.g.selectAll(".data_element").attr("stroke","black"),s.updateCellStroke()),s},s.updateCanvas);function d(t){for(var e,a,r=!0,n=s.rowIds(),o=0,l=1;r&&o<n.length;)void 0===e?e=s.get_value(n[o],t):void 0!==(a=s.get_value(n[o],t))&&(l++,r=e==s.get_matchComplementary(a)),o++;return r&&1<l}return s.updateCanvas=function(){if(e(),s.highlightMatches()){var a=s.canvas.node().getContext("2d"),r=(a.strokeStyle="black",a.lineWidth=2,s.dispRowIds()),n=s.dispColIds(),t=n.length,o=r.length;for(let e=0;e<t;e++)if(d(n[e])){var l,i=s.axes.scale_x(s.get_heatmapCol(n[e]));for(let t=0;t<o;t++)void 0!==s.get_value(r[t],n[e])&&(l=s.axes.scale_y(s.get_heatmapRow(r[t])),a.strokeRect(i,l,s.cellSize.width,s.cellSize.height))}}return s},s.updateCellStroke=function(){return s.checkMode()&&"svg"==("default"==s.mode()?2500<s.dispColIds().length*s.dispRowIds().length?"canvas":"svg":s.mode())&&(0<s.transitionDuration()&&!s.transitionOff?s.g.selectAll(".data_element").transition("cellStroke").duration(s.transitionDuration()).attr("stroke-width",function(t){var e=s.get_value(t[0],t[1]),t=d(t[1]);return d3.select(this).classed("matching",t),void 0!==e&&t?2:0}):s.g.selectAll(".data_element").attr("stroke-width",function(t){var e=s.get_value(t[0],t[1]),t=d(t[1]);return d3.select(this).classed("matching",t),void 0!==e&&t?2:0})),s},s},t.table=function(){var e=x().add_property("record",{}),a=(e.showPanel(!1),e.put_static_content),r=(e.put_static_content=function(t){a(t),e.svg.remove(),e.table=e.container.append("table")},e.updateSize=function(){return e.table.style("width",e.width()),e.table.selectAll("td").style("height",e.height()/Object.keys(e.record()).length),e},e.update);return e.update=function(){r();var t=e.table.selectAll("tr").data(Object.keys(e.record()));return t.exit().remove(),t.enter().append("tr").merge(t).html(function(t){return"<td>"+t+"</td><td>"+e.get_record()[t]+"</td>"}),e.table.selectAll("td").style("border-bottom","1px solid #ddd"),e},e},t.xLine=k,t.yLine=S});